...
public class ShipwreckNetherStructure extends AbstractBaseStructure<NetherShipwreckConfig> {
    ...
    public class Start extends NoiseAffectingStructureStart<NetherShipwreckConfig> {
        ...
        @Override
        public void init(RegistryAccess dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos1, Biome biome, NetherShipwreckConfig config, LevelHeightAccessor heightLimitView) {
