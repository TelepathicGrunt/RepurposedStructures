		...
		public RSConfigValues(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber)
		{
			...
			builder.push("Mod-wide Impacting Options");
				...
				blacklistedDimensions = subscriber.subscribe(builder
						...
						.define("blacklistedDimensions", "the_bumblezone:the_bumblezone, twilightforest:twilightforest, undergarden:undergarden, the_midnight:the_midnight, theabyss:theabyssdim, theabyss:theabyssiceworld, theabyss:death, theabyss:the_end_of_time, theabyss:the_end_of_time_2"));
