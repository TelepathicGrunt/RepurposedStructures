...
public class MobMapTrades {
    ...
    public static void onVillagerTradesEvent(VillagerTradesEvent event)
    {
        if(event.getType() == VillagerProfession.CARTOGRAPHER)
        {
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionDesertMaxChunkDistance.get() != 1001)
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionJungleMaxChunkDistance.get() != 1001)
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionOakMaxChunkDistance.get() != 1001)
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionSavannaMaxChunkDistance.get() != 1001)
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionSnowyMaxChunkDistance.get() != 1001)
            ...
            if(RepurposedStructures.RSMansionsConfig.mansionTaigaMaxChunkDistance.get() != 1001)
