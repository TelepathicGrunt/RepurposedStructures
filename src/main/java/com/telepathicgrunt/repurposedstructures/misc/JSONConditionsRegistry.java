...
public final class JSONConditionsRegistry {
    ...
    public static final Registry<Supplier<Boolean>> RS_JSON_CONDITIONS_REGISTRY = (Registry<Supplier<Boolean>>) Registry.register(TEMP_CLASS_TYPE.getClass(), RS_JSON_CONDITIONS_KEY.location()).buildAndRegister();
