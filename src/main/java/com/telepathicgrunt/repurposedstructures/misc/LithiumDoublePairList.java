...
/**
 * From Lithium (LGPLv3)
 * Source: https://github.com/CaffeineMC/lithium-fabric/blob/1.16.x/dev/src/main/java/me/jellysquid/mods/lithium/common/shapes/pairs/LithiumDoublePairList.java
 *
 * We need this to help optimize the structure bounding boxes a bit when Lithium isn't on.
 *
 * -----------------------------------------------------------------------------------------------------------------
 *
 * Optimized variant of {@link net.minecraft.util.math.shapes.IDoubleListMerger}. This implementation works directly against
