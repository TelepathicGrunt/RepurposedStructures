...
public class VillagerTradesModification {
    ...
    public static void addMapTrades(){
        ...
        cartographer_trades.add(new VillagerTrades.EmeraldForMapTrade(13, RSStructures.JUNGLE_FORTRESS, MapDecoration.Type.BANNER_GREEN, 12, 5));
        ...
        cartographer_trades.add(new VillagerTrades.EmeraldForMapTrade(14, RSStructures.JUNGLE_FORTRESS, MapDecoration.Type.BANNER_GREEN, 12, 10));
