        ...
        consumer.accept(new ResourceLocation(RepurposedStructures.MODID, "chests/bastions/underground/bridge"),
            LootTable.lootTable().withPool(
                ...
                LootPool.lootPool().setRolls(RandomValueRange.between(2, 3)).bonusRolls(1, 1)
                        ...
                        .add(ItemLootEntry.lootTableItem(Items.TIPPED_ARROW).setWeight(12).apply(SetCount.setCount(RandomValueRange.between(7, 24))).apply(SetNBT.setTag(LootTableUtils.getPotionNbt("minecraft:harming"))))
                        .add(ItemLootEntry.lootTableItem(Items.TIPPED_ARROW).setWeight(12).apply(SetCount.setCount(RandomValueRange.between(6, 18))).apply(SetNBT.setTag(LootTableUtils.getPotionNbt("minecraft:strong_harming"))))
                    ...
                    LootPool.lootPool().setRolls(ConstantRange.exactly(0)).bonusRolls(1, 1)
                            ...
                            .add(ItemLootEntry.lootTableItem(Items.PINK_BANNER).apply(SetNBT.setTag(LootTableUtils.getTransBannerNBT())))
                            .add(ItemLootEntry.lootTableItem(Items.BLACK_BANNER).setWeight(4).apply(SetNBT.setTag(LootTableUtils.getBannerNBT("{Patterns:[{Pattern:cr,Color:0},{Pattern:cr,Color:15},{Pattern:cbo,Color:0},{Pattern:cbo,Color:15},{Pattern:bo,Color:0},{Pattern:bo,Color:0},{Pattern:mr,Color:8},{Pattern:mr,Color:8},{Pattern:mr,Color:15},{Pattern:bo,Color:15},{Pattern:mc,Color:7},{Pattern:mc,Color:15}]}"))))
