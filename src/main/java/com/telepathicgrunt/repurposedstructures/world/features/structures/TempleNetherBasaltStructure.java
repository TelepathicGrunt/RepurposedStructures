...
public class TempleNetherBasaltStructure extends StructureFeature<NoFeatureConfig> {
    static {
        ...
        StructurePoolBasedGenerator.REGISTRY.add(
                new StructurePool(new ResourceLocation(RepurposedStructures.MODID,"temples/temple_nether_basalt"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(
