...
//		}
//		else {
//		    int maxLimit = (int) (structurestrongholdpieces$pieceweight.instancesLimit * (RepurposedStructures.RSStrongholdsConfig.strongholdSizeSH.get() * 0.01D));
//
...
//
//
//    private static RSStrongholdPieces.Stronghold findAndCreatePieceFactory(Class<? extends RSStrongholdPieces.Stronghold> pieceClass, List<StructurePiece> piecesList, Random random, int xStart, int yStart, int zStart, @Nullable Direction direction, int distanceFromStart, RSStrongholdStructure.Type stronghold$type) {
...
//	RSStrongholdStructure.Type stronghold$type = ((RSStrongholdPieces.Stronghold) p_175955_0_).strongholdType;
...
//	int maxComponents = (int) (50 * (RepurposedStructures.RSStrongholdsConfig.strongholdSizeSH.get() * 0.01D));
...
//    {
//	public ChestCorridor(int componentType, Random p_i45582_2_, BlockBox p_i45582_3_, Direction p_i45582_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.ChestCorridor createPiece(List<StructurePiece> p_175868_0_, Random p_175868_1_, int x, int y, int z, Direction p_175868_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 7, p_175868_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175868_0_, mutableboundingbox) == null ? new RSStrongholdPieces.ChestCorridor(componentType, p_175868_1_, mutableboundingbox, p_175868_5_, strongholdType) : null;
//	}
//
//
//	@Override
//	public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox structureBoundingBoxIn, ChunkPos chunkPos) {
...
//	    this.fillWithOutline(world, structureBoundingBoxIn, 3, 1, 2, 3, 1, 4, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), false);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICK_SLAB.getDefaultState()), 3, 1, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICK_SLAB.getDefaultState()), 3, 1, 5, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICK_SLAB.getDefaultState()), 3, 2, 2, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICK_SLAB.getDefaultState()), 3, 2, 4, structureBoundingBoxIn);
//
//	    for (int i = 2; i <= 4; ++i) {
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICK_SLAB.getDefaultState()), 2, 1, i, structureBoundingBoxIn);
//	    }
//
//	    if (structureBoundingBoxIn.contains(new BlockPos(this.applyXTransform(3, 3), this.applyYTransform(2), this.applyZTransform(3, 3)))) {
//		if (RepurposedStructures.RSStrongholdsConfig.lootChestsSH.get() && random.nextInt(3) == 0) {
...
//
//
//	public Corridor(int componentType, BlockBox p_i50137_2_, Direction p_i50137_3_, RSStrongholdStructure.Type strongholdType) {
...
//	    StructurePiece structurePiece = StructurePiece.method_14932(p_175869_0_, mutableboundingbox);
//
//	    if (structurePiece == null) {
//		return null;
//	    }
...
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 0, 0, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 0, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 0, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 0, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 4, 0, i, structureBoundingBoxIn);
//
//		for (int j = 1; j <= 3; ++j) {
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 0, j, i, structureBoundingBoxIn);
...
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 4, j, i, structureBoundingBoxIn);
//		}
//
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 0, 4, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 4, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 4, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 4, i, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 4, 4, i, structureBoundingBoxIn);
//	    }
//
//	    return true;
//	}
...
//
//
//	public Crossing(int componentType, Random p_i45580_2_, BlockBox p_i45580_3_, Direction p_i45580_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.Crossing createPiece(List<StructurePiece> p_175866_0_, Random p_175866_1_, int x, int y, int z, Direction p_175866_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -4, -3, 0, 10, 9, 11, p_175866_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175866_0_, mutableboundingbox) == null ? new RSStrongholdPieces.Crossing(componentType, p_175866_1_, mutableboundingbox, p_175866_5_, strongholdType) : null;
//	}
//
//
//	@Override
...
//	    this.fillWithOutline(world, structureBoundingBoxIn, 1, 3, 4, 3, 3, 4, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 1, 4, 6, 3, 4, 6, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 5, 1, 7, 7, 1, 8, false, random, randomStrongholdBlocks);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 5, 1, 9, 7, 1, 9, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 5, 2, 7, 7, 2, 7, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 4, 5, 7, 4, 5, 9, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 8, 5, 7, 8, 5, 9, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 5, 5, 7, 7, 5, 9, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()).with(SlabBlock.TYPE, SlabType.DOUBLE), this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()).with(SlabBlock.TYPE, SlabType.DOUBLE), false);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.SOUTH), 6, 5, 6, structureBoundingBoxIn);
//	    return true;
//	}
//    }
//
...
//    {
//	public LeftTurn(int componentType, Random p_i45579_2_, BlockBox p_i45579_3_, Direction p_i45579_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.LeftTurn createPiece(List<StructurePiece> p_175867_0_, Random p_175867_1_, int x, int y, int z, Direction p_175867_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, p_175867_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175867_0_, mutableboundingbox) == null ? new RSStrongholdPieces.LeftTurn(componentType, p_175867_1_, mutableboundingbox, p_175867_5_, strongholdType) : null;
//	}
//
//
//	@Override
...
//
//
//	public Library(int componentType, Random p_i45578_2_, BlockBox p_i45578_3_, Direction p_i45578_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.Library createPiece(List<StructurePiece> p_175864_0_, Random p_175864_1_, int x, int y, int z, Direction p_175864_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -4, -1, 0, 14, 11, 15, p_175864_5_);
//
//	    if (!canStrongholdGoDeeper(mutableboundingbox) || StructurePiece.method_14932(p_175864_0_, mutableboundingbox) != null) {
...
//
//		if (!allBookshelfBlocks.isEmpty()) bookshelfBlock = ((Block) allBookshelfBlocks.toArray()[random.nextInt(allBookshelfBlocks.size())]).getDefaultState();
//	    }
//
...
//	    for (int l = 1; l <= 13; ++l) {
//		if ((l - 1) % 4 == 0) {
//		    this.fillWithOutline(world, structureBoundingBoxIn, 1, 1, l, 1, 4, l, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		    this.fillWithOutline(world, structureBoundingBoxIn, 12, 1, l, 12, 4, l, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST), 2, 3, l, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST), 11, 3, l, structureBoundingBoxIn);
//		    if (this.isLargeRoom) {
//			this.fillWithOutline(world, structureBoundingBoxIn, 1, 6, l, 1, 9, l, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//			this.fillWithOutline(world, structureBoundingBoxIn, 12, 6, l, 12, 9, l, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		    }
//		}
//		else {
...
//
//	    if (this.isLargeRoom) {
//		this.fillWithOutline(world, structureBoundingBoxIn, 1, 5, 1, 3, 5, 13, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		this.fillWithOutline(world, structureBoundingBoxIn, 10, 5, 1, 12, 5, 13, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		this.fillWithOutline(world, structureBoundingBoxIn, 4, 5, 1, 9, 5, 2, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		this.fillWithOutline(world, structureBoundingBoxIn, 4, 5, 12, 9, 5, 13, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), false);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 9, 5, 11, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 8, 5, 11, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 9, 5, 10, structureBoundingBoxIn);
//		BlockState iblockstate5 = this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.WEST, Boolean.valueOf(true)).with(HorizontalConnectingBlock.EAST, Boolean.valueOf(true));
//		BlockState iblockstate = this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.NORTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.SOUTH, Boolean.valueOf(true));
...
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.NORTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.EAST, Boolean.valueOf(true)), 3, 6, 2, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.SOUTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.EAST, Boolean.valueOf(true)), 3, 6, 12, structureBoundingBoxIn);
//		this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.NORTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.WEST, Boolean.valueOf(true)), 10, 6, 2, structureBoundingBoxIn);
//
//		for (int i1 = 0; i1 <= 2; ++i1) {
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.SOUTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.WEST, Boolean.valueOf(true)), 8 + i1, 6, 12 - i1, structureBoundingBoxIn);
//		    if (i1 != 2) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.NORTH, Boolean.valueOf(true)).with(HorizontalConnectingBlock.EAST, Boolean.valueOf(true)), 8 + i1, 6, 11 - i1, structureBoundingBoxIn);
//		    }
//		}
//
...
//		BlockState iblockstate1 = this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.EAST, Boolean.valueOf(true));
//		this.addBlock(world, iblockstate1, 6, 9, 7, structureBoundingBoxIn);
//		BlockState iblockstate2 = this.getBlockOfCorrectType(Blocks.OAK_FENCE.getDefaultState()).with(HorizontalConnectingBlock.WEST, Boolean.valueOf(true));
...
//		BlockState iblockstate4 = this.getBlockOfCorrectType(Blocks.TORCH.getDefaultState());
...
//	    }
//
//	    if (RepurposedStructures.RSStrongholdsConfig.lootChestsSH.get()) {
//		this.addChest(world, structureBoundingBoxIn, random, 3, 3, 5, LootTables.CHESTS_STRONGHOLD_LIBRARY);
//	    }
//
//	    if (this.isLargeRoom) {
...
//
//		if (RepurposedStructures.RSStrongholdsConfig.lootChestsSH.get()) {
//		    this.addChest(world, structureBoundingBoxIn, random, 12, 8, 1, LootTables.CHESTS_STRONGHOLD_LIBRARY);
//		}
//	    }
//
//	    return true;
...
//
//	public boolean canSpawnMoreStructures(int distanceFromStart) {
//	    int maxLimit = (int) (this.instancesLimit * (RepurposedStructures.RSStrongholdsConfig.strongholdSizeSH.get() * 0.01D));
//
...
//    {
//	public PortalRoom(int componentType, BlockBox p_i50131_2_, Direction p_i50131_3_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.PortalRoom createPiece(List<StructurePiece> p_175865_0_, Random p_175865_1_, int x, int y, int z, Direction p_175865_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -4, -1, 0, 11, 8, 16, p_175865_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175865_0_, mutableboundingbox) == null ? new RSStrongholdPieces.PortalRoom(componentType, mutableboundingbox, p_175865_5_, strongholdType) : null;
//	}
//
//
//	public static RSStrongholdPieces.PortalRoom createPiece(List<StructurePiece> p_175865_0_, Random p_175865_1_, int x, int y, int z, Direction p_175865_5_, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -4, -1, 0, 11, 8, 16, p_175865_5_);
...
//		this.fillWithOutline(world, structureBoundingBoxIn, 0, 3, j, 0, 4, j, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), false);
//		this.fillWithOutline(world, structureBoundingBoxIn, 10, 3, j, 10, 4, j, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), false);
//	    }
//
//	    for (int i1 = 2; i1 < 9; i1 += 2) {
//		this.fillWithOutline(world, structureBoundingBoxIn, i1, 3, 15, i1, 4, 15, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), false);
//	    }
//
//	    BlockState iblockstate3 = this.getBlockOfCorrectType(Blocks.STONE_BRICK_STAIRS.getDefaultState()).with(StairsBlock.FACING, Direction.NORTH);
...
//		    ((MobSpawnerBlockEntity) tileentity).getLogic().setEntityId(getSpawnerEntity());
//		}
//	    }
//
//	    return true;
...
//    {
//	public Prison(int componentType, Random p_i45576_2_, BlockBox p_i45576_3_, Direction p_i45576_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.Prison createPiece(List<StructurePiece> p_175860_0_, Random p_175860_1_, int x, int y, int z, Direction p_175860_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -1, 0, 9, 5, 11, p_175860_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175860_0_, mutableboundingbox) == null ? new RSStrongholdPieces.Prison(componentType, p_175860_1_, mutableboundingbox, p_175860_5_, strongholdType) : null;
//	}
//
//
//	@Override
...
//	    this.fillWithOutline(world, structureBoundingBoxIn, 4, 1, 4, 4, 3, 6, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), false);
//	    this.fillWithOutline(world, structureBoundingBoxIn, 5, 1, 5, 7, 3, 5, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), false);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), 4, 3, 2, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), 4, 3, 8, structureBoundingBoxIn);
//	    BlockState iblockstate = this.getBlockOfCorrectType(Blocks.IRON_DOOR.getDefaultState()).with(DoorBlock.FACING, Direction.WEST);
//	    BlockState iblockstate1 = this.getBlockOfCorrectType(Blocks.IRON_DOOR.getDefaultState()).with(DoorBlock.FACING, Direction.WEST).with(DoorBlock.HALF, DoubleBlockHalf.UPPER);
...
//    {
//	public RightTurn(int componentType, Random p_i50127_2_, BlockBox p_i50127_3_, Direction p_i50127_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.RightTurn createPiece(List<StructurePiece> p_214824_0_, Random p_214824_1_, int x, int y, int z, Direction p_214824_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -1, 0, 5, 5, 5, p_214824_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_214824_0_, mutableboundingbox) == null ? new RSStrongholdPieces.RightTurn(componentType, p_214824_1_, mutableboundingbox, p_214824_5_, strongholdType) : null;
//	}
//    }
//
...
//
//
//	public RoomCrossing(int componentType, Random p_i45575_2_, BlockBox p_i45575_3_, Direction p_i45575_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.RoomCrossing createPiece(List<StructurePiece> p_175859_0_, Random p_175859_1_, int x, int y, int z, Direction p_175859_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -4, -1, 0, 11, 7, 11, p_175859_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175859_0_, mutableboundingbox) == null ? new RSStrongholdPieces.RoomCrossing(componentType, p_175859_1_, mutableboundingbox, p_175859_5_, strongholdType) : null;
//	}
//
//
//	@Override
...
//		    if (structureBoundingBoxIn.contains(blockpos)) {
//
//			if (RepurposedStructures.RSStrongholdsConfig.allowExtraSpawnersSH.get()) {
//			    world.setBlockState(blockpos, Blocks.SPAWNER.getDefaultState(), 2);
//			    BlockEntity tileentity = world.getBlockEntity(blockpos);
//
//			    if (tileentity instanceof MobSpawnerBlockEntity) {
...
//			}
//			else {
//			    world.setBlockState(blockpos, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2);
//			}
//		    }
//
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 5, 2, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 5, 3, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST), 4, 3, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST), 6, 3, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.SOUTH), 5, 3, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.NORTH), 5, 3, 6, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 4, 1, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 4, 1, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 4, 1, 6, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 6, 1, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 6, 1, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 6, 1, 6, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 5, 1, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 5, 1, 6, structureBoundingBoxIn);
//		    break;
//
//		case 1:
//		    for (int i1 = 0; i1 < 5; ++i1) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 1, 3 + i1, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 7, 1, 3 + i1, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3 + i1, 1, 3, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3 + i1, 1, 7, structureBoundingBoxIn);
//		    }
//
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 5, 2, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 5, 3, 5, structureBoundingBoxIn);
...
//		    }
//
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.WATER.getDefaultState()), 5, 4, 5, structureBoundingBoxIn);
//		    break;
//
//		case 2:
//		case 3:
//
//		    for (int i = 1; i <= 9; ++i) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 1, 3, i, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 9, 3, i, structureBoundingBoxIn);
//		    }
//
//		    for (int j = 1; j <= 9; ++j) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), j, 3, 1, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), j, 3, 9, structureBoundingBoxIn);
//		    }
//
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 5, 1, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 5, 1, 6, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 5, 3, 4, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 5, 3, 6, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 4, 1, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 6, 1, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 4, 3, 5, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 6, 3, 5, structureBoundingBoxIn);
//
//		    for (int k = 1; k <= 3; ++k) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 4, k, 4, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 6, k, 4, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 4, k, 6, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.COBBLESTONE.getDefaultState()), 6, k, 6, structureBoundingBoxIn);
//		    }
//
//		    blockpos = new BlockPos(this.applyXTransform(5, 5), this.applyYTransform(1), this.applyZTransform(5, 5));
//
...
//				((MobSpawnerBlockEntity) tileentity).getLogic().setEntityId(getSpawnerEntity());
//			    }
//			    this.addBlock(world, this.getBlockOfCorrectType(Blocks.TORCH.getDefaultState()), 5, 2, 5, structureBoundingBoxIn);
//			}
//			else {
//			    this.addBlock(world, this.getBlockOfCorrectType(Blocks.TORCH.getDefaultState()), 5, 1, 5, structureBoundingBoxIn);
//			}
//		    }
//
//
//		    for (int l = 2; l <= 8; ++l) {
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 2, 3, l, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 3, 3, l, structureBoundingBoxIn);
//			if (l <= 3 || l >= 7) {
//			    this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 4, 3, l, structureBoundingBoxIn);
//			    this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 5, 3, l, structureBoundingBoxIn);
//			    this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 6, 3, l, structureBoundingBoxIn);
//			}
//
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 7, 3, l, structureBoundingBoxIn);
//			this.addBlock(world, this.getBlockOfCorrectType(Blocks.OAK_PLANKS.getDefaultState()), 8, 3, l, structureBoundingBoxIn);
//		    }
//
...
//
//
//	public Stairs(StructurePieceType p_i50120_1_, int componentType, Random p_i50120_3_, int x, int z, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public Stairs(int componentType, Random p_i45574_2_, BlockBox p_i45574_3_, Direction p_i45574_4_, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.Stairs createPiece(List<StructurePiece> p_175863_0_, Random p_175863_1_, int x, int y, int z, Direction p_175863_5_, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -7, 0, 5, 11, 5, p_175863_5_);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(p_175863_0_, mutableboundingbox) == null ? new RSStrongholdPieces.Stairs(componentType, p_175863_1_, mutableboundingbox, p_175863_5_, strongholdType) : null;
//	}
//
//
//	@Override
...
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 6, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 5, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 1, 6, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 5, 2, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 4, 3, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 1, 5, 3, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 4, 3, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 3, 3, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 3, 4, 3, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 3, 2, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 2, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 3, 3, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 2, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 1, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 1, 2, 1, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 1, 2, structureBoundingBoxIn);
//	    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_SLAB.getDefaultState()), 1, 1, 3, structureBoundingBoxIn);
//	    return true;
//	}
//    }
//
...
//    {
//	public StairsStraight(int componentType, Random random, BlockBox box, Direction direction, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.StairsStraight createPiece(List<StructurePiece> piecesList, Random random, int x, int y, int z, Direction direction, int componentType, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(x, y, z, -1, -7, 0, 5, 11, 8, direction);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(piecesList, mutableboundingbox) == null ? new RSStrongholdPieces.StairsStraight(componentType, random, mutableboundingbox, direction, strongholdType) : null;
//	}
//
//
//	@Override
...
//	    BlockState iblockstate = this.getBlockOfCorrectType(Blocks.STONE_BRICK_STAIRS.getDefaultState()).with(StairsBlock.FACING, Direction.SOUTH);
//
//	    for (int i = 0; i < 6; ++i) {
...
//
//		if (i < 5) {
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 1, 5 - i, 1 + i, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 2, 5 - i, 1 + i, structureBoundingBoxIn);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), 3, 5 - i, 1 + i, structureBoundingBoxIn);
//		}
//	    }
//
//	    return true;
...
//	    if (notAir) {
//		if (type == RSStrongholdStructure.Type.NETHER) {
...
//		    float silverfishThreshold = (float) (RepurposedStructures.RSStrongholdsConfig.silverfishSpawnrateSH.get() / 100);
...
//
//
//	public Straight(int conponentType_, Random random, BlockBox box, Direction direction, RSStrongholdStructure.Type strongholdType) {
...
//
//
//	public static RSStrongholdPieces.Straight createPiece(List<StructurePiece> piecesList, Random random, int xStart, int yStart, int zStart, Direction direction, int distanceFromStart, RSStrongholdStructure.Type strongholdType) {
//	    BlockBox mutableboundingbox = BlockBox.rotated(xStart, yStart, zStart, -1, -1, 0, 5, 5, 7, direction);
//	    return canStrongholdGoDeeper(mutableboundingbox) && StructurePiece.method_14932(piecesList, mutableboundingbox) == null ? new RSStrongholdPieces.Straight(distanceFromStart, random, mutableboundingbox, direction, strongholdType) : null;
//	}
//
//
//	@Override
...
//	    this.placeDoor(world, random, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
//	    this.placeDoor(world, random, structureBoundingBoxIn, RSStrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
//	    BlockState iblockstate = this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST);
//	    BlockState iblockstate1 = this.getBlockOfCorrectType(Blocks.WALL_TORCH.getDefaultState()).with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST);
...
//
//
//	protected Stronghold(StructurePieceType pieceType, int componentType, RSStrongholdStructure.Type strongholdType) {
...
//	    this.strongholdType = RSStrongholdStructure.Type.byId(data.getInt("SHT"));
//	}
//
//
//	/**
...
//
//
//	protected void placeDoor(IWorld world, Random random, BlockBox mutableBox, RSStrongholdPieces.Stronghold.Door spawnDoor, int xStart, int yStart, int zStart) {
//	    switch (spawnDoor) {
//		case OPENING:
...
//
//		case WOOD_DOOR:
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart, yStart, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 1, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 2, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 2, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 2, yStart, zStart, mutableBox);
//		    if (this.strongholdType == RSStrongholdStructure.Type.NETHER) {
...
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart, yStart, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart + 1, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart + 2, yStart + 2, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart + 2, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_BARS.getDefaultState()), xStart + 2, yStart, zStart, mutableBox);
//		    break;
//
//		case IRON_DOOR:
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart, yStart, zStart, mutableBox);
...
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 2, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BRICKS.getDefaultState()), xStart + 2, yStart, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_DOOR.getDefaultState()), xStart + 1, yStart, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.IRON_DOOR.getDefaultState()).with(DoorBlock.HALF, DoubleBlockHalf.UPPER), xStart + 1, yStart + 1, zStart, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BUTTON.getDefaultState()).with(HorizontalFacingBlock.HORIZONTAL_FACING, Direction.NORTH), xStart + 2, yStart + 1, zStart + 1, mutableBox);
//		    this.addBlock(world, this.getBlockOfCorrectType(Blocks.STONE_BUTTON.getDefaultState()).with(HorizontalFacingBlock.HORIZONTAL_FACING, Direction.SOUTH), xStart + 2, yStart + 1, zStart - 1, mutableBox);
//	    }
//	}
//
//
...
//	    if (this.strongholdType == RSStrongholdStructure.Type.NETHER && NETHER_BLOCK_MAP.containsKey(blockstate.getBlock())) {
//		BlockState newBlockstate = NETHER_BLOCK_MAP.get(blockstate.getBlock()).getDefaultState();
//
//		if (newBlockstate.getBlock() instanceof SlabBlock) {
//		    newBlockstate.with(SlabBlock.TYPE, blockstate.get(Properties.SLAB_TYPE));
//		}
//		else if (newBlockstate.getBlock() instanceof DoorBlock) {
//		    newBlockstate.with(DoorBlock.FACING, blockstate.get(HorizontalFacingBlock.HORIZONTAL_FACING));
//		}
//		else if (newBlockstate.getBlock() instanceof WallTorchBlock) {
//		    newBlockstate.with(WallTorchBlock.HORIZONTAL_FACING, blockstate.get(HorizontalFacingBlock.HORIZONTAL_FACING));
//		}
//
...
//		switch (enumfacing) {
//		    case NORTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ - 1, enumfacing, this.method_14923());
//
//		    case SOUTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.maxZ + 1, enumfacing, this.method_14923());
//
//		    case WEST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, this.method_14923());
//
//		    case EAST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, enumfacing, this.method_14923());
//
//		    default:
//			break;
//		}
...
//		switch (enumfacing) {
//		    case NORTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, Direction.WEST, this.method_14923());
//
//		    case SOUTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ + p_74989_5_, Direction.WEST, this.method_14923());
//
//		    case WEST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, Direction.NORTH, this.method_14923());
//
//		    case EAST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74989_1_, p_74989_2_, p_74989_3_, this.boundingBox.minX + p_74989_5_, this.boundingBox.minY + p_74989_4_, this.boundingBox.minZ - 1, Direction.NORTH, this.method_14923());
//
...
//		switch (enumfacing) {
//		    case NORTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, Direction.EAST, this.method_14923());
//
//		    case SOUTH:
//			return RSStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74987_4_, this.boundingBox.minZ + p_74987_5_, Direction.EAST, this.method_14923());
//
//		    case WEST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, Direction.SOUTH, this.method_14923());
//
//		    case EAST:
//			return RSStrongholdPieces.generateAndAddPiece(p_74987_1_, p_74987_2_, p_74987_3_, this.boundingBox.minX + p_74987_5_, this.boundingBox.minY + p_74987_4_, this.boundingBox.maxZ + 1, Direction.SOUTH, this.method_14923());
//
...
//    {
//	protected Turn(StructurePieceType pieceType, int componentType, RSStrongholdStructure.Type strongholdType) {
