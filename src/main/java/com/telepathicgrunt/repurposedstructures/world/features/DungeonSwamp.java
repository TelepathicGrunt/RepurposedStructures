...
public class DungeonSwamp extends Feature<DefaultFeatureConfig> {
    public DungeonSwamp() {
    ...
    private static final Identifier CHEST_LOOT = new Identifier(RepurposedStructures.MODID, "chests/dungeon/swamp");
