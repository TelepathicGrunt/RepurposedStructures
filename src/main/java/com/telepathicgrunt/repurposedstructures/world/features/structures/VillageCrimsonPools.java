    ...
    static {
       ...
       ImmutableList<StructureProcessor> zombiefy = ImmutableList.of(new RuleStructureProcessor(
	       ImmutableList.of(
			   ...
			   new RuleEntry(new BlockStateMatchRuleTest(Blocks.REDSTONE_WALL_TORCH.getDefaultState().with(RedstoneWallTorchBlock.FACING, Direction.NORTH)), AlwaysTrueRuleTest.INSTANCE, Blocks.field_235340_cR_.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.NORTH)),
			   new RuleEntry(new BlockStateMatchRuleTest(Blocks.REDSTONE_WALL_TORCH.getDefaultState().with(RedstoneWallTorchBlock.FACING, Direction.SOUTH)), AlwaysTrueRuleTest.INSTANCE, Blocks.field_235340_cR_.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.SOUTH)),
			   new RuleEntry(new BlockStateMatchRuleTest(Blocks.REDSTONE_WALL_TORCH.getDefaultState().with(RedstoneWallTorchBlock.FACING, Direction.EAST)), AlwaysTrueRuleTest.INSTANCE, Blocks.field_235340_cR_.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST)),
			   new RuleEntry(new BlockStateMatchRuleTest(Blocks.REDSTONE_WALL_TORCH.getDefaultState().with(RedstoneWallTorchBlock.FACING, Direction.WEST)), AlwaysTrueRuleTest.INSTANCE, Blocks.field_235340_cR_.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST)),
