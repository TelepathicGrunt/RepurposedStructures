...
public class StructurePieces
{
	...
	public static IStructurePieceType 	NTHRTMP				= NetherTemplePiece::new;
	public static IStructurePieceType 	BLTMP				= BadlandsTemplePiece::new;
	...
	public static void registerStructurePieces()
	{
		...
		RegUtil.register(NTHRTMP, 		"NthrTmP");
		RegUtil.register(BLTMP, 		"BlTmP");
	}
