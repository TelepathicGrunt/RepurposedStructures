...
public class VillageMountainsPools
{
	...
	ImmutableList<StructureProcessor> crop_randomizer = ImmutableList.of(new RuleStructureProcessor(
       ...
       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier("village/mountains/zombie/houses"), new Identifier("village/mountains/terminators"),
	       ImmutableList.of(
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/small_house_1", zombiefy), 4),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/small_house_2", zombiefy), 4),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/small_house_3", zombiefy), 4),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/small_house_4", zombiefy), 4),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/small_house_5", zombiefy), 4),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/medium_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/medium_house_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/medium_house_3", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/medium_house_4", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/butcher_shop_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/tool_smith_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/fletcher_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/shepherds_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/armorer_house_1", zombiefy), 1),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/fisher_cottage_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/tannery_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/cartographer_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/library_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/masons_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/weaponsmith_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/weaponsmith_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/temple_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/large_farm_1", zombiefy), 6),
		       new Pair<>(new SinglePoolElement("village/mountains/zombie/houses/large_farm_2", zombiefy), 6),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/small_farm_1", zombiefy), 1),
		       new Pair<>(new SinglePoolElement("village/mountains/houses/animal_pen_1", zombiefy), 2),
