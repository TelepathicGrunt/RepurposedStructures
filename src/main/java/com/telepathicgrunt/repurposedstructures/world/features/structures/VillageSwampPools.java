...
public class VillageSwampPools
{
    ...
    static {
       ...
       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier("village/swamp/zombie/houses"), new Identifier("village/swamp/terminators"),
	       ImmutableList.of(
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_3", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_4", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_5", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_6", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_7", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/small_house_8", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/medium_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/medium_house_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/zombie/houses/medium_house_3", zombiefy), 1),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/butchers_shop_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/butchers_shop_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/tool_smith_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/fletcher_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/shepherds_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/armorer_house_1", zombiefy), 1),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/armorer_house_2", zombiefy), 1),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/fisher_cottage", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/tannery_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/cartographer_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/library_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/masons_house_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/masons_house_2", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/weapon_smith_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/temple_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/farm_1", zombiefy), 3),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/farm_2", zombiefy), 3),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/animal_pen_1", zombiefy), 2),
		       new Pair<>(new SinglePoolElement("village/swamp/houses/animal_pen_2", zombiefy), 2),
