...
public class VillageGiantTaigaPools
{
	...
	ImmutableList<StructureProcessor> crop_randomizer = ImmutableList.of(new RuleStructureProcessor(
		ImmutableList.of(
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier("village/giant_taiga/zombie/houses"), new Identifier("village/giant_taiga/terminators"),
		       ImmutableList.of(
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_3", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_4", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_5", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_6", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_7", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/small_house_8", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/medium_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/medium_house_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/zombie/houses/medium_house_3", zombiefy), 1),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/butchers_shop_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/butchers_shop_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/tool_smith_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/fletcher_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/shepherds_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/armorer_house_1", zombiefy), 1),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/armorer_house_2", zombiefy), 1),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/fisher_cottage", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/tannery_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/cartographer_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/library_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/masons_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/masons_house_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/weapon_smith_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/temple_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/farm_1", zombiefy), 3),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/farm_2", zombiefy), 3),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/animal_pen_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement("village/giant_taiga/houses/animal_pen_2", zombiefy), 2),
