...
public class VillageBirchStructure extends StructureFeature<DefaultFeatureConfig> {
    ...
    public static class Start extends VillageStructureStart<DefaultFeatureConfig> {
        ...
        public void init(ChunkGenerator chunkGenerator, StructureManager structureManager, int chunkX, int chunkZ, Biome biome, DefaultFeatureConfig defaultFeatureConfig) {
            ...
            VillageGenerator.addPieces(chunkGenerator, structureManager, blockpos, this.children, this.random, new StructurePoolFeatureConfig(new Identifier(RepurposedStructures.MODID + ":village/birch/town_centers"), 6));
