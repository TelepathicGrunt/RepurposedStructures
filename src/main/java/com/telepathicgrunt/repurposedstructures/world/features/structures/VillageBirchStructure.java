...
public class VillageBirchStructure extends Structure<NoFeatureConfig>
{
    /**
     * --------------------------------------------------------------------------
     * |									|
     ...
     */
    public VillageBirchStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
	super(config);
    }
	...
	int maxDistance = RepurposedStructures.RSVillagesConfig.birchVillageSpawnrate.get();
	...
	public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biomeIn) {
	    ...
	    VillagePieces.addPieces(generator, templateManager, blockpos, this.components, this.rand, new VillageConfig(RepurposedStructures.MODID + ":village/birch/town_centers", 6));
