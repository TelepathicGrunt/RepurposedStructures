...
public class RSMineshaftSavannaStructure extends Structure<NoFeatureConfig>
{
	...
	public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
	    ...
	    int minimum = RepurposedStructures.RSConfig.savannaMineshaftMinHeight.get();
	    int maximum = Math.max(RepurposedStructures.RSConfig.savannaMineshaftMaxHeight.get(), minimum)+1;
