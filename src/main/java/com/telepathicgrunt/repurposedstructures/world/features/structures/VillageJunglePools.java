...
public class VillageJunglePools
{
	...
	tempList.add(RSFeatures.JUNGLE_VILLAGE);
    ...
    static {
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/jungle/houses"), new ResourceLocation(RepurposedStructures.MODID+":village/jungle/terminators"), 
	       ImmutableList.of(
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/animal_pen_1", mossify), 1), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/animal_pen_2", mossify), 1), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/animal_pen_3", mossify), 5), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/armorer_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/butcher_shop_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/butcher_shop_2", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/cartographer_1", mossify), 1), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/fisher_cottage_1", mossify), 2), 
		       ...
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/library_1", mossify), 5), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/masons_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/medium_house_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/medium_house_2", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/shepherds_1", mossify), 2), 
		       ...
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/tannery_1", mossify), 2), 
		       ...
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/tool_smith_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/weaponsmith_1", mossify), 2), 
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/houses/weaponsmith_2", mossify), 2),
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/jungle/trees"), new ResourceLocation("empty"), 
	       ImmutableList.of(
		       new Pair<>(new FeatureJigsawPiece(Feature.MEGA_JUNGLE_TREE.withConfiguration(DefaultBiomeFeatures.MEGA_JUNGLE_TREE_CONFIG)), 1)), 
	       JigsawPattern.PlacementBehaviour.RIGID));
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/jungle/decor"), new ResourceLocation("empty"), 
	       ImmutableList.of(new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/jungle/decor/lamp_1"), 2), 
		       new Pair<>(new FeatureJigsawPiece(Feature.NORMAL_TREE.withConfiguration(DefaultBiomeFeatures.JUNGLE_TREE_CONFIG)), 1), 
		       new Pair<>(new FeatureJigsawPiece(Feature.FLOWER.withConfiguration(DefaultBiomeFeatures.FOREST_FLOWER_CONFIG)), 1), 
		       new Pair<>(new FeatureJigsawPiece(Feature.BLOCK_PILE.withConfiguration(DefaultBiomeFeatures.MELON_PILE_CONFIG)), 1), 
