...
public class RSMineshaftOceanStructure extends AbstractMineshaftStructure {
    ...
    public double mineshaftProbability() {
        return RepurposedStructures.RSMineshaftsConfig.spawnrate.oceanMineshaftSpawnrate;
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(ChunkGenerator chunkGenerator, StructureManager structureManager, int chunkX, int chunkZ, Biome biome, DefaultFeatureConfig defaultFeatureConfig) {
            RSMineshaftPieces.Room structuremineshaftpiecesua$room = new RSMineshaftPieces.Room(0, this.random, (chunkX << 4) + 2, (chunkZ << 4) + 2, RSMineshaftPieces.Type.OCEAN);
            ...
            int minimum = RepurposedStructures.RSMineshaftsConfig.minHeight.oceanMineshaftMinHeight;
            int maximum = Math.max(RepurposedStructures.RSMineshaftsConfig.maxHeight.oceanMineshaftMaxHeight, minimum) + 1;
