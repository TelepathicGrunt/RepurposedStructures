...
public class RSNewMineshaftStructure extends AdvancedJigsawStructure {
    ...
    public RSNewMineshaftStructure(Identifier poolID, int structureSize, Map<Identifier, StructurePiecesBehavior.RequiredPieceNeeds> requiredPieces, int maxY, int minY, float probability, ENVIRONMENT_CHECK environmentCheck) {
    ...
    public StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return RSNewMineshaftStructure.Start::new;
    }
