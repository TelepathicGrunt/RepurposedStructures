...
public class VillageSwampPools
{
    ...
    static {
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/swamp/zombie/houses"), new ResourceLocation(RepurposedStructures.MODID+":village/swamp/terminators"),
	       ImmutableList.of(
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_3", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_4", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_5", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_6", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_7", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/small_house_8", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/medium_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/medium_house_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/zombie/houses/medium_house_3", zombiefy), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/butchers_shop_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/butchers_shop_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/tool_smith_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/fletcher_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/shepherds_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/armorer_house_1", zombiefy), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/armorer_house_2", zombiefy), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/fisher_cottage", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/tannery_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/cartographer_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/library_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/masons_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/masons_house_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/weapon_smith_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/temple_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/farm_1", zombiefy), 3),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/farm_2", zombiefy), 3),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/animal_pen_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/houses/animal_pen_2", zombiefy), 2),
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/swamp/trees"), new ResourceLocation("empty"),
	       ImmutableList.of(
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SWAMP_TREE_CONFIG)), 1)),
	       JigsawPattern.PlacementBehaviour.RIGID));
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/swamp/decor"), new ResourceLocation("empty"),
	       ImmutableList.of(new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/decor/lamp_post_01"), 1),
		       ...
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SWAMP_TREE_CONFIG)), 1),
		       new Pair<>(new FeatureJigsawPiece(Feature.FLOWER.configure(DefaultBiomeFeatures.BLUE_ORCHID_CONFIG)), 1),
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/swamp/zombie/decor"), new ResourceLocation("empty"),
	       ImmutableList.of(
		       ...
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/decor/lamp_post_02"), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/swamp/decor/lamp_post_03"), 1),
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SWAMP_TREE_CONFIG)), 2),
		       new Pair<>(new FeatureJigsawPiece(Feature.FLOWER.configure(DefaultBiomeFeatures.BLUE_ORCHID_CONFIG)), 2),
		       new Pair<>(new FeatureJigsawPiece(Feature.field_227244_A_.configure(DefaultBiomeFeatures.PUMPKIN_PILE_CONFIG)), 2),
		       Pair.of(EmptyJigsawPiece.INSTANCE, 2)),
	       JigsawPattern.PlacementBehaviour.RIGID));
