		...
		ImmutableList.of(
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(RepurposedStructures.MODID+":village/giant_taiga/town_centers"), new Identifier("empty"),
		       ImmutableList.of(new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/town_centers/meeting_point_1", path_randomizer_and_mossify), 50),
	        		       ...
	        		       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/town_centers/meeting_point_1", path_randomizer_and_mossify), 1),
	        		       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/town_centers/meeting_point_2", path_randomizer_and_mossify), 1),
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(RepurposedStructures.MODID+":village/giant_taiga/streets"), new Identifier(RepurposedStructures.MODID+":village/giant_taiga/terminators"),
		       ImmutableList.of(
			       ...
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/corner_03", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_01", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_02", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_03", path_randomizer), 7),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_04", path_randomizer), 7),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_06", path_randomizer), 3),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/straight_08", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_01", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_02", path_randomizer), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_03", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_04", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_05", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/crossroad_06", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/square_01", path_randomizer), 1),
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets"), new Identifier(RepurposedStructures.MODID+":village/giant_taiga/terminators"),
		       ImmutableList.of(
			       ...
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/corner_03", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_01", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_02", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_03", path_randomizer), 7),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_04", path_randomizer), 7),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_06", path_randomizer), 3),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/straight_08", path_randomizer), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_01", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_02", path_randomizer), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_03", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_04", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_05", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/streets/crossroad_06", path_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/streets/square_01", path_randomizer), 1),
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(RepurposedStructures.MODID+":village/giant_taiga/houses"), new Identifier(RepurposedStructures.MODID+":village/giant_taiga/terminators"),
		       ImmutableList.of(
			       ...
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/armorer_house_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/armorer_house_2", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/butcher_shop_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/butcher_shop_2", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/cartographer_house_1", mossify), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/farm_1", crop_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/farm_2", crop_randomizer), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/fisher_cottage", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/fletcher_house_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/library_1", mossify), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/masons_house_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/masons_house_2", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/medium_house_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/medium_house_2", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/medium_house_3", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/shepherds_house_1"), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_1", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_2", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_3", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_4", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_5", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_6", mossify), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_7", mossify), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/small_house_8", mossify), 3),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/tannery_1", mossify), 4),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/temple_1", mossify), 5),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/tool_smith_1", mossify), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/weapon_smith_1", mossify), 1),
	       ...
	       StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses"), new Identifier(RepurposedStructures.MODID+":village/giant_taiga/terminators"),
		       ImmutableList.of(
			       ...
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_3", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_4", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_5", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_6", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_7", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/small_house_8", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/medium_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/medium_house_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/zombie/houses/medium_house_3", zombiefy), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/butchers_shop_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/butchers_shop_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/tool_smith_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/fletcher_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/shepherds_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/armorer_house_1", zombiefy), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/armorer_house_2", zombiefy), 1),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/fisher_cottage", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/tannery_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/cartographer_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/library_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/masons_house_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/masons_house_2", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/weapon_smith_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/temple_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/farm_1", zombiefy), 3),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/farm_2", zombiefy), 3),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/animal_pen_1", zombiefy), 2),
			       new Pair<>(new SinglePoolElement(RepurposedStructures.MODID+":village/giant_taiga/houses/animal_pen_2", zombiefy), 2),
