...
public class VillageMountainsPools
{
	...
	ImmutableList<StructureProcessor> crop_randomizer = ImmutableList.of(new RuleStructureProcessor(
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/mountains/zombie/houses"), new ResourceLocation(RepurposedStructures.MODID+":village/mountains/terminators"),
	       ImmutableList.of(
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/small_house_1", zombiefy), 4),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/small_house_2", zombiefy), 4),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/small_house_3", zombiefy), 4),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/small_house_4", zombiefy), 4),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/small_house_5", zombiefy), 4),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/medium_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/medium_house_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/medium_house_3", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/medium_house_4", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/butcher_shop_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/tool_smith_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/fletcher_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/shepherds_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/armorer_house_1", zombiefy), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/fisher_cottage_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/tannery_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/cartographer_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/library_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/masons_house_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/weaponsmith_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/weaponsmith_2", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/temple_1", zombiefy), 2),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/large_farm_1", zombiefy), 6),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/zombie/houses/large_farm_2", zombiefy), 6),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/small_farm_1", zombiefy), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/houses/animal_pen_1", zombiefy), 2),
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/mountains/trees"), new ResourceLocation("empty"),
	       ImmutableList.of(
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SPRUCE_TREE_CONFIG)), 1)),
	       JigsawPattern.PlacementBehaviour.RIGID));
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/mountains/decor"), new ResourceLocation("empty"),
	       ImmutableList.of(new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/decor/lamp_post_1"), 1),
		       ...
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SPRUCE_TREE_CONFIG)), 1),
		       new Pair<>(new FeatureJigsawPiece(Feature.FLOWER.configure(DefaultBiomeFeatures.DEFAULT_FLOWER_CONFIG)), 1),
       ...
       JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/mountains/zombie/decor"), new ResourceLocation("empty"),
	       ImmutableList.of(
		       ...
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/decor/decoration_5"), 1),
		       new Pair<>(new SingleJigsawPiece(RepurposedStructures.MODID+":village/mountains/decor/decoration_6"), 1),
		       new Pair<>(new FeatureJigsawPiece(Feature.field_236291_c_.configure(DefaultBiomeFeatures.SPRUCE_TREE_CONFIG)), 2),
		       new Pair<>(new FeatureJigsawPiece(Feature.FLOWER.configure(DefaultBiomeFeatures.DEFAULT_FLOWER_CONFIG)), 2),
		       new Pair<>(new FeatureJigsawPiece(Feature.field_227244_A_.configure(RSFeatures.COBBLESTONE_PILE_CONFIG)), 2),
		       Pair.of(EmptyJigsawPiece.INSTANCE, 2)),
	       JigsawPattern.PlacementBehaviour.RIGID));

		JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(RepurposedStructures.MODID+":village/mountains/zombie/villagers"), new ResourceLocation("empty"),
				ImmutableList.of(
						new Pair(new LegacySingleJigsawPiece("village/taiga/zombie/villagers/nitwit"), 1),
						new Pair(new LegacySingleJigsawPiece("village/taiga/zombie/villagers/unemployed"), 10)),
				JigsawPattern.PlacementBehaviour.RIGID));
    }
}