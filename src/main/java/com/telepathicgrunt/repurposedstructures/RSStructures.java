...
public class RSStructures {
    ...
    public static void registerStructures(RegistryEvent.Register<Structure<?>> event) {
        ...
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_birch"), BIRCH_MINESHAFT, new StructureSeparationSettings(1, 0, 399117345));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_desert"), DESERT_MINESHAFT, new StructureSeparationSettings(1, 0, 1990612785));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_end"), END_MINESHAFT, new StructureSeparationSettings(1, 0, 2057488602));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_nether"), NETHER_MINESHAFT, new StructureSeparationSettings(1, 0, 1220811654));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_icy"), ICY_MINESHAFT, new StructureSeparationSettings(1, 0, 1451015246));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_jungle"), JUNGLE_MINESHAFT, new StructureSeparationSettings(1, 0, 1434412876));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_ocean"), OCEAN_MINESHAFT, new StructureSeparationSettings(1, 0, 1774808662));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_savanna"), SAVANNA_MINESHAFT, new StructureSeparationSettings(1, 0, 1960212212));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_stone"), STONE_MINESHAFT, new StructureSeparationSettings(1, 0, 1436736620));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_swamp_or_dark_forest"), SWAMP_OR_DARK_FOREST_MINESHAFT, new StructureSeparationSettings(1, 0, 2037177700));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "mineshaft_taiga"), TAIGA_MINESHAFT, new StructureSeparationSettings(1, 0, 1383003172));

        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "stronghold_stonebrick"), STONEBRICK_STRONGHOLD, new StructureSeparationSettings(RepurposedStructures.RSStrongholdsConfig.stonebrickStrongholdSpawnrate.get(), (int) (RepurposedStructures.RSStrongholdsConfig.stonebrickStrongholdSpawnrate.get() * 0.5f), 1098192663));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "stronghold_nether"), NETHER_STRONGHOLD, new StructureSeparationSettings(RepurposedStructures.RSStrongholdsConfig.netherStrongholdSpawnrate.get(), (int) (RepurposedStructures.RSStrongholdsConfig.netherStrongholdSpawnrate.get() * 0.5f), 1731422513));

        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "fortress_jungle"), JUNGLE_FORTRESS, new StructureSeparationSettings(RepurposedStructures.RSMainConfig.jungleFortressSpawnrate.get(), (int) (RepurposedStructures.RSMainConfig.jungleFortressSpawnrate.get() * 0.5f), 1464189157));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "igloo_grassy"), GRASSY_IGLOO, new StructureSeparationSettings(RepurposedStructures.RSMainConfig.grassyIglooSpawnrate.get(), (int) (RepurposedStructures.RSMainConfig.grassyIglooSpawnrate.get() * 0.5f), 1460835582));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "igloo_stone"), STONE_IGLOO, new StructureSeparationSettings(RepurposedStructures.RSMainConfig.stoneIglooSpawnrate.get(), (int) (RepurposedStructures.RSMainConfig.stoneIglooSpawnrate.get() * 0.5f), 1327429039));

        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "temple_nether_wasteland"), NETHER_WASTELAND_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherWastelandTempleSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherWastelandTempleSpawnrate.get() * 0.5f), 1435489909));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "temple_nether_soul"), NETHER_SOUL_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherSoulTempleSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherSoulTempleSpawnrate.get() * 0.5f), 1799485937));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "temple_nether_basalt"), NETHER_BASALT_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherBasaltTempleSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherBasaltTempleSpawnrate.get() * 0.5f), 1063117750));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "temple_nether_crimson"), NETHER_CRIMSON_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherCrimsonTempleSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherCrimsonTempleSpawnrate.get() * 0.5f), 1898896156));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "temple_nether_warped"), NETHER_WARPED_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherWarpedTempleSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherWarpedTempleSpawnrate.get() * 0.5f), 1635542708));

        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "outpost_nether_brick"), NETHER_BRICK_OUTPOST, new StructureSeparationSettings(RepurposedStructures.RSOutpostsConfig.netherBrickOutpostSpawnrate.get(), (int) (RepurposedStructures.RSOutpostsConfig.netherBrickOutpostSpawnrate.get() * 0.5f), 1305971394));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "outpost_warped"), WARPED_OUTPOST, new StructureSeparationSettings(RepurposedStructures.RSOutpostsConfig.warpedOutpostSpawnrate.get(), (int) (RepurposedStructures.RSOutpostsConfig.warpedOutpostSpawnrate.get() * 0.5f), 1928816918));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "outpost_crimson"), CRIMSON_OUTPOST, new StructureSeparationSettings(RepurposedStructures.RSOutpostsConfig.crimsonOutpostSpawnrate.get(), (int) (RepurposedStructures.RSOutpostsConfig.crimsonOutpostSpawnrate.get() * 0.5f), 1951425662));

        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "pyramid_badlands"), BADLANDS_TEMPLE, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.badlandsPyramidSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.badlandsPyramidSpawnrate.get() * 0.5f), 1718729448));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "pyramid_nether"), NETHER_PYRAMID, new StructureSeparationSettings(RepurposedStructures.RSTemplesConfig.netherPyramidSpawnrate.get(), (int) (RepurposedStructures.RSTemplesConfig.netherPyramidSpawnrate.get() * 0.5f), 2054372964));

        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "shipwreck_end"), END_SHIPWRECK, new StructureSeparationSettings(RepurposedStructures.RSShipwrecksConfig.endShipwreckSpawnrate.get(), (int) (RepurposedStructures.RSShipwrecksConfig.endShipwreckSpawnrate.get() * 0.5f), 1605500075));
        registerStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "shipwreck_nether_bricks"), NETHER_BRICKS_SHIPWRECK, new StructureSeparationSettings(RepurposedStructures.RSShipwrecksConfig.netherBricksShipwreckSpawnrate.get(), (int) (RepurposedStructures.RSShipwrecksConfig.netherBricksShipwreckSpawnrate.get() * 0.5f), 2073308006));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "shipwreck_crimson"), CRIMSON_SHIPWRECK, new StructureSeparationSettings(RepurposedStructures.RSShipwrecksConfig.crimsonShipwreckSpawnrate.get(), (int) (RepurposedStructures.RSShipwrecksConfig.crimsonShipwreckSpawnrate.get() * 0.5f), 1019716871));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "shipwreck_warped"), WARPED_SHIPWRECK, new StructureSeparationSettings(RepurposedStructures.RSShipwrecksConfig.warpedShipwreckSpawnrate.get(), (int) (RepurposedStructures.RSShipwrecksConfig.warpedShipwreckSpawnrate.get() * 0.5f), 2072979641));

        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_badlands"), BADLANDS_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.badlandsVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.badlandsVillageSpawnrate.get() * 0.5f), 1319707555));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_birch"), BIRCH_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.birchVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.birchVillageSpawnrate.get() * 0.5f), 1102567365));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_dark_oak"), DARK_FOREST_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.darkForestVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.darkForestVillageSpawnrate.get() * 0.5f), 1921339358));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_jungle"), JUNGLE_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.jungleVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.jungleVillageSpawnrate.get() * 0.5f), 1229975218));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_swamp"), SWAMP_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.swampVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.swampVillageSpawnrate.get() * 0.5f), 1559650945));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_mountains"), MOUNTAINS_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.mountainsVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.mountainsVillageSpawnrate.get() * 0.5f), 2010875989));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_giant_taiga"), GIANT_TAIGA_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.giantTaigaVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.giantTaigaVillageSpawnrate.get() * 0.5f), 1559528842));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_crimson"), CRIMSON_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.crimsonVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.crimsonVillageSpawnrate.get() * 0.5f), 1854750198));
        registerLandscapeTransformingStructure(event.getRegistry(), new ResourceLocation(RepurposedStructures.MODID, "village_warped"), WARPED_VILLAGE, new StructureSeparationSettings(RepurposedStructures.RSVillagesConfig.warpedVillageSpawnrate.get(), (int) (RepurposedStructures.RSVillagesConfig.warpedVillageSpawnrate.get() * 0.5f), 1298332136));
    ...
    public static <F extends Structure<NoFeatureConfig>> void registerLandscapeTransformingStructure(
        ...
        registerStructure(registry, resourceLocation, structure, StructureSeparationSettings);
    }
