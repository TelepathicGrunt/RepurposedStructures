...
public class Mineshafts {
    ...
    public static void addMineshafts() {
        GeneralUtils.addToBiome("birch_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.BIRCH_MINESHAFT,
        ...
        GeneralUtils.addToBiome("jungle_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.JUNGLE_MINESHAFT,
        ...
        GeneralUtils.addToBiome("desert_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.DESERT_MINESHAFT,
        ...
        GeneralUtils.addToBiome("stone_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.STONE_MINESHAFT,
        ...
        GeneralUtils.addToBiome("savanna_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.SAVANNA_MINESHAFT,
        ...
        GeneralUtils.addToBiome("icy_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.ICY_MINESHAFT,
        ...
        GeneralUtils.addToBiome("ocean_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.OCEAN_MINESHAFT,
        ...
        GeneralUtils.addToBiome("taiga_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.TAIGA_MINESHAFT,
        ...
        GeneralUtils.addToBiome("dark_forest_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.DARK_FOREST_MINESHAFT,
        ...
        GeneralUtils.addToBiome("swamp_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.SWAMP_MINESHAFT,
        ...
        GeneralUtils.addToBiome("end_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.END_MINESHAFT,
        ...
        GeneralUtils.addToBiome("nether_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.NETHER_MINESHAFT,
        ...
        GeneralUtils.addToBiome("crimson_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.CRIMSON_MINESHAFT,
        ...
        GeneralUtils.addToBiome("warped_mineshaft",
                (context) -> 
                        genericMineshaftCheck(context, RSStructures.WARPED_MINESHAFT,
