...
public class Mineshafts {
    ...
    public static void addMineshafts(BiomeLoadingEvent event) {
        ...
        {
            event.getGeneration().getStructures().add(() -> RSConfiguredStructures.DARK_FOREST_MINESHAFT);
        }
        ...
        {
            event.getGeneration().getStructures().add(() -> RSConfiguredStructures.SWAMP_MINESHAFT);
        }
        ...
        {
            event.getGeneration().getStructures().add(() -> RSConfiguredStructures.CRIMSON_MINESHAFT);
        }
        ...
        {
            event.getGeneration().getStructures().add(() -> RSConfiguredStructures.WARPED_MINESHAFT);
        }
