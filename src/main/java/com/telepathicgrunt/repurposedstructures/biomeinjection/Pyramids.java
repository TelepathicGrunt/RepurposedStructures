    ...
    public static void addPyramids() {
        ...
        GeneralUtils.addToBiome("nether_pyramid",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.netherPyramidMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("badlands_pyramid",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.badlandsPyramidMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_snowy",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidSnowyMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_end",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidEndMaxChunkDistance != 10001,
                ...
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.PYRAMID_ICY,
                                ...
                                && (BiomeSelection.hasName(context, "icy", "ice", "frozen")
                                    || (context.getBiome().getTemperature() < 0 && !BiomeSelection.hasName(context, "snow"))))
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidIcyMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_jungle",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidJungleMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_mushroom",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidMushroomMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_ocean",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidOceanMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_giant_tree_taiga",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidGiantTreeTaigaMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("pyramid_flower_forest",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSPyramidsConfig.pyramidFlowerForestMaxChunkDistance != 10001,
