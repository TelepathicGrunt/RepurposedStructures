...
public class Dungeons {
    ...
    public static void addDungeons() {
        ...
        GeneralUtils.addToBiome("jungle_dungeon",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.JUNGLE_DUNGEONS)
        ...
        GeneralUtils.addToBiome("badlands_dungeon",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.BADLANDS_DUNGEONS)
        ...
        GeneralUtils.addToBiome("dark_forest_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.DARK_FOREST_DUNGEONS)
        ...
        GeneralUtils.addToBiome("desert_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.DESERT_DUNGEONS)
        ...
        GeneralUtils.addToBiome("high_mushroom_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.MUSHROOM_HIGH_DUNGEONS)
        ...
        GeneralUtils.addToBiome("low_mushroom_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.MUSHROOM_LOW_DUNGEONS)
                        && RepurposedStructures.RSAllConfig.RSDungeonsConfig.attemptsPerChunk.mushroomDungeonAttemptsPerChunk != 0
                        && BiomeSelection.haveCategories(context, Category.MUSHROOM),
                context -> {
        ...
        GeneralUtils.addToBiome("swamp_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.SWAMP_DUNGEONS)
        ...
        GeneralUtils.addToBiome("snow_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.SNOW_DUNGEONS)
        ...
        GeneralUtils.addToBiome("icy_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.ICY_DUNGEONS)
        ...
        GeneralUtils.addToBiome("nether_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.NETHER_DUNGEONS)
        ...
        GeneralUtils.addToBiome("end_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.END_DUNGEONS)
        ...
        GeneralUtils.addToBiome("ocean_neutral_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.OCEAN_NEUTRAL_DUNGEONS)
        ...
        GeneralUtils.addToBiome("ocean_cold_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.OCEAN_COLD_DUNGEONS)
                        && RepurposedStructures.RSAllConfig.RSDungeonsConfig.attemptsPerChunk.oceanDungeonAttemptsPerChunk != 0
                        && BiomeSelection.haveCategories(context, Category.OCEAN)
        ...
        GeneralUtils.addToBiome("ocean_frozen_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.OCEAN_FROZEN_DUNGEONS)
                        && RepurposedStructures.RSAllConfig.RSDungeonsConfig.attemptsPerChunk.oceanDungeonAttemptsPerChunk != 0
                        && BiomeSelection.haveCategories(context, Category.OCEAN)
        ...
        GeneralUtils.addToBiome("ocean_lukewarm_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.OCEAN_LUKEWARM_DUNGEONS)
                        && RepurposedStructures.RSAllConfig.RSDungeonsConfig.attemptsPerChunk.oceanDungeonAttemptsPerChunk != 0
                        && BiomeSelection.haveCategories(context, Category.OCEAN)
        ...
        GeneralUtils.addToBiome("ocean_warm_dungeons",
                (context) -> genericDungeonCheck(context, RSConfiguredFeatures.OCEAN_WARM_DUNGEONS)
                        && RepurposedStructures.RSAllConfig.RSDungeonsConfig.attemptsPerChunk.oceanDungeonAttemptsPerChunk != 0
                        && BiomeSelection.haveCategories(context, Category.OCEAN)
    ...
    private static boolean genericDungeonCheck(BiomeSelectionContext context, ConfiguredFeature<?,?> configuredFeatures) {
        return RSConfiguredFeatures.RS_DUNGEONS.stream().noneMatch(context::hasBuiltInFeature)
                && BiomeSelection.isBiomeAllowed(context, configuredFeatures);
    }
}
