...
public final class Dungeons {
    ...
    public static void addDungeons() {
        ...
        GeneralUtils.addToBiome("deep_dungeons",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSConfiguredFeatures.DEEP_DUNGEONS_PLACED,
                                () -> !BiomeSelection.haveCategories(context, Biome.BiomeCategory.NETHER, Biome.BiomeCategory.THEEND, Biome.BiomeCategory.NONE))
                ...
                context ->  {
                    ...
                    context.getGenerationSettings().removeBuiltInFeature(CavePlacements.MONSTER_ROOM_DEEP);
                });
