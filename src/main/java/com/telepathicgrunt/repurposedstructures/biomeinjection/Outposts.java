    ...
    public static void addOutposts() {
        ...
        GeneralUtils.addToBiome("crimson_outpost",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.crimsonOutpostMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("warped_outpost",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.WARPED_OUTPOST,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.warpedOutpostMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("nether_brick_outpost",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.NETHER_BRICK_OUTPOST,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.netherBrickOutpostMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_birch",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostBirchMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_jungle",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.OUTPOST_JUNGLE,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostJungleMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_giant_tree_taiga",
                (context) ->
                        ...
                        && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostGiantTreeTaigaMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_desert",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.OUTPOST_DESERT,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostDesertMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_badlands",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.OUTPOST_BADLANDS,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostBadlandsMaxChunkDistance != 10001,
                ...
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.OUTPOST_SNOWY,
                            ...
                            || (BiomeSelection.haveCategories(context, Category.ICY) && !(BiomeSelection.hasName(context, "ice", "icy", "glacier", "frozen"))))
                                && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostSnowyMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_icy",
                (context) ->
                        BiomeSelection.isBiomeAllowed(context, RSStructures.OUTPOST_ICY,
                            ...
                            && BiomeSelection.doesNotHaveStructureType(context, RSStructureTagMap.STRUCTURE_TAGS.OVERWORLD_OUTPOST))
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostIcyMaxChunkDistance != 10001,
        ...
        GeneralUtils.addToBiome("outpost_taiga",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostTaigaMaxChunkDistance != 10001),
        ...
        GeneralUtils.addToBiome("outpost_oak",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostOakMaxChunkDistance != 10001),
        ...
        GeneralUtils.addToBiome("outpost_end",
                (context) ->
                        ...
                        && RepurposedStructures.RSAllConfig.RSOutpostsConfig.outpostEndMaxChunkDistance != 10001),
