...
public class RSConfiguredFeatures {
    ...
    private static NbtDungeonConfig getDefaultNbtDungeonConfig(String dungeonType, ResourceLocation postProcessor){
        return getNbtDungeonConfig(dungeonType, dungeonType, postProcessor);
    }

    private static NbtDungeonConfig getNbtDungeonConfig(String dungeonType, String spawnerType, ResourceLocation postProcessor){
    ...
    private static NbtDungeonConfig getOceanNbtDungeonConfig(String spawnerType, ResourceLocation postProcessor){
        return new NbtDungeonConfig(
                false,1, 55, 2,
    ...
    private static final NbtDungeonConfig BADLANDS_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("badlands", EMPTY_ID);
    ...
    private static final NbtDungeonConfig DARK_FOREST_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("dark_forest", new ResourceLocation(RepurposedStructures.MODID, "dungeons/dark_forest_post_process"));
    ...
    private static final NbtDungeonConfig DESERT_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("desert", EMPTY_ID);
    ...
    private static final NbtDungeonConfig NETHER_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("nether", EMPTY_ID);
    ...
    private static final NbtDungeonConfig SNOW_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("snow", EMPTY_ID);
    ...
    private static final NbtDungeonConfig MUSHROOM_HIGH_DUNGEON_CONFIG = getNbtDungeonConfig("mushroom", "mushroom_high", EMPTY_ID);
    ...
    private static final NbtDungeonConfig MUSHROOM_LOW_DUNGEON_CONFIG = getNbtDungeonConfig("mushroom", "mushroom_low", EMPTY_ID);
    ...
    private static final NbtDungeonConfig JUNGLE_DUNGEON_CONFIG = getDefaultNbtDungeonConfig("jungle", new ResourceLocation(RepurposedStructures.MODID, "dungeons/jungle_post_process"));
    ...
    public static ConfiguredFeature<?, ?> OCEAN_COLD_DUNGEONS = RSFeatures.OCEAN_DUNGEONS.get().configure(getOceanNbtDungeonConfig("ocean_cold", EMPTY_ID))
            .decorate(RSPlacements.RS_DUNGEON_PLACEMENT.get().configure(new TopSolidRangeConfig(
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMinHeight.get(), 0,
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMaxHeight.get()))
                    .decorate(RSPlacements.RS_UNLIMITED_COUNT.get().configure(new FeatureSpreadConfig(RepurposedStructures.RSDungeonsConfig.oceanDungeonAttemptsPerChunk.get()))));

    public static ConfiguredFeature<?, ?> OCEAN_FROZEN_DUNGEONS = RSFeatures.OCEAN_DUNGEONS.get().configure(getOceanNbtDungeonConfig("ocean_frozen", EMPTY_ID))
            .decorate(RSPlacements.RS_DUNGEON_PLACEMENT.get().configure(new TopSolidRangeConfig(
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMinHeight.get(), 0,
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMaxHeight.get()))
                    .decorate(RSPlacements.RS_UNLIMITED_COUNT.get().configure(new FeatureSpreadConfig(RepurposedStructures.RSDungeonsConfig.oceanDungeonAttemptsPerChunk.get()))));

    public static ConfiguredFeature<?, ?> OCEAN_LUKEWARM_DUNGEONS = RSFeatures.OCEAN_DUNGEONS.get().configure(getOceanNbtDungeonConfig("ocean_lukewarm", EMPTY_ID))
            .decorate(RSPlacements.RS_DUNGEON_PLACEMENT.get().configure(new TopSolidRangeConfig(
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMinHeight.get(), 0,
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMaxHeight.get()))
                    .decorate(RSPlacements.RS_UNLIMITED_COUNT.get().configure(new FeatureSpreadConfig(RepurposedStructures.RSDungeonsConfig.oceanDungeonAttemptsPerChunk.get()))));

    public static ConfiguredFeature<?, ?> OCEAN_WARM_DUNGEONS = RSFeatures.OCEAN_DUNGEONS.get().configure(getOceanNbtDungeonConfig("ocean_warm", EMPTY_ID))
            .decorate(RSPlacements.RS_DUNGEON_PLACEMENT.get().configure(new TopSolidRangeConfig(
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMinHeight.get(), 0,
                    RepurposedStructures.RSDungeonsConfig.oceanDungeonMaxHeight.get()))
                    .decorate(RSPlacements.RS_UNLIMITED_COUNT.get().configure(new FeatureSpreadConfig(RepurposedStructures.RSDungeonsConfig.oceanDungeonAttemptsPerChunk.get()))));
