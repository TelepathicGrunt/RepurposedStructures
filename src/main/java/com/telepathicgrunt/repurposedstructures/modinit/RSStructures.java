...
public final class RSStructures {
    ...
    //Strongholds
    public static final RegistryObject<Structure<NoFeatureConfig>> STRONGHOLD_NETHER = addToStructureMaps("stronghold_nether", () -> (new AdvancedDistanceJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "strongholds/nether/start_pool")).setStructureSize(RSStrongholdsConfig.strongholdNetherSize).setMaxY(RSStrongholdsConfig.strongholdNetherMaxHeight).setMinY(RSStrongholdsConfig.strongholdNetherMinHeight).setDistanceFromWorldOrigin(2817).build()));
    ...
    public static void setupStructures() {
        ...
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "stronghold_nether"), STRONGHOLD_NETHER.get(), GenerationStage.Decoration.TOP_LAYER_MODIFICATION, createSpacingAndSalt(RSStrongholdsConfig.strongholdNetherAverageChunkDistance.get(), 0.5f, 1731422513));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "stronghold_end"), STRONGHOLD_END.get(), GenerationStage.Decoration.STRONGHOLDS, new StructureSeparationSettings(RSStrongholdsConfig.strongholdEndAverageChunkDistance.get(), (int) (RSStrongholdsConfig.strongholdEndAverageChunkDistance.get() * 0.5f), 1922886435));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "fortress_jungle"), FORTRESS_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSFortressesConfig.jungleFortressAverageChunkDistance.get(), 0.5f, 1464189157));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "igloo_grassy"), IGLOO_GRASSY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSIgloosConfig.grassyIglooAverageChunkDistance.get(), 0.5f, 1460835582));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "igloo_stone"), IGLOO_STONE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSIgloosConfig.stoneIglooAverageChunkDistance.get(), 0.5f, 1327429039));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_wasteland"), TEMPLE_NETHER_WASTELAND.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherWastelandTempleAverageChunkDistance.get(), 0.5f, 1435489909));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_soul"), TEMPLE_NETHER_SOUL.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherSoulTempleAverageChunkDistance.get(), 0.5f, 1799485937));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_basalt"), TEMPLE_NETHER_BASALT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherBasaltTempleAverageChunkDistance.get(), 0.5f, 1063117750));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_crimson"), TEMPLE_NETHER_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherCrimsonTempleAverageChunkDistance.get(), 0.5f, 1898896156));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_warped"), TEMPLE_NETHER_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherWarpedTempleAverageChunkDistance.get(), 0.5f, 1635542708));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_nether_brick"), OUTPOST_NETHER_BRICK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostNetherBrickAverageChunkDistance.get(), 0.5f, 1305971394));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_warped"), OUTPOST_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostWarpedAverageChunkDistance.get(), 0.5f, 1928816918));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_crimson"), OUTPOST_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostCrimsonAverageChunkDistance.get(), 0.5f, 1951425662));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_birch"), OUTPOST_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostBirchAverageChunkDistance.get(), 0.5f, 1676743168));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_jungle"), OUTPOST_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostJungleAverageChunkDistance.get(), 0.5f, 548433028));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_giant_tree_taiga"), OUTPOST_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostGiantTreeTaigaAverageChunkDistance.get(), 0.5f, 993252541));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_desert"), OUTPOST_DESERT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostDesertAverageChunkDistance.get(), 0.5f, 593099376));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_badlands"), OUTPOST_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostBadlandsAverageChunkDistance.get(), 0.5f, 1702026868));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_snowy"), OUTPOST_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostSnowyAverageChunkDistance.get(), 0.5f, 849388460));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_icy"), OUTPOST_ICY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostIcyAverageChunkDistance.get(), 0.5f, 935294633));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_taiga"), OUTPOST_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostTaigaAverageChunkDistance.get(), 0.5f, 272805097));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_oak"), OUTPOST_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostOakAverageChunkDistance.get(), 0.5f, 698118385));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_end"), OUTPOST_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostEndAverageChunkDistance.get(), 0.5f, 831830630));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_badlands"), PYRAMID_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidBadlandsAverageChunkDistance.get(), 0.5f, 1718729448));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_nether"), PYRAMID_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidNetherAverageChunkDistance.get(), 0.5f, 2054372964));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_snowy"), PYRAMID_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidSnowyAverageChunkDistance.get(), 0.5f, 1630533493));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_end"), PYRAMID_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidEndAverageChunkDistance.get(), 0.5f, 1145023315));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_icy"), PYRAMID_ICY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidIcyAverageChunkDistance.get(), 0.5f, 884076931));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_jungle"), PYRAMID_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidJungleAverageChunkDistance.get(), 0.5f, 1483015905));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_mushroom"), PYRAMID_MUSHROOM.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidMushroomAverageChunkDistance.get(), 0.5f, 1035759391));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_ocean"), PYRAMID_OCEAN.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidOceanAverageChunkDistance.get(), 0.5f, 777281414));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_giant_tree_taiga"), PYRAMID_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidGiantTreeTaigaAverageChunkDistance.get(), 0.5f, 1977974973));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_flower_forest"), PYRAMID_FLOWER_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidFlowerForestAverageChunkDistance.get(), 0.5f, 1984904323));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_end"), SHIPWRECK_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.shipwreckEndAverageChunkDistance.get(), 0.5f, 1605500075));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_nether_bricks"), SHIPWRECK_NETHER_BRICKS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.shipwreckNetherBricksAverageChunkDistance.get(), 0.5f, 2073308006), new NetherShipwreckConfig(true));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_crimson"), SHIPWRECK_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.shipwreckCrimsonAverageChunkDistance.get(), 0.5f, 1019716871), new NetherShipwreckConfig(false));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_warped"), SHIPWRECK_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.shipwreckWarpedAverageChunkDistance.get(), 0.5f, 2072979641), new NetherShipwreckConfig(false));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_badlands"), VILLAGE_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageBadlandsAverageChunkDistance.get(), 0.5f, 1319707555));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_birch"), VILLAGE_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageBirchAverageChunkDistance.get(), 0.5f, 1102567365));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_dark_oak"), VILLAGE_DARK_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageDarkForestAverageChunkDistance.get(), 0.5f, 1921339358));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_jungle"), VILLAGE_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageJungleAverageChunkDistance.get(), 0.5f, 1229975218));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_swamp"), VILLAGE_SWAMP.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageSwampAverageChunkDistance.get(), 0.5f, 1559650945));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_mountains"), VILLAGE_MOUNTAINS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageMountainsAverageChunkDistance.get(), 0.5f, 2010875989));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_giant_taiga"), VILLAGE_GIANT_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageGiantTaigaAverageChunkDistance.get(), 0.5f, 1559528842));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_crimson"), VILLAGE_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageCrimsonAverageChunkDistance.get(), 0.5f, 1854750198));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_warped"), VILLAGE_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageWarpedAverageChunkDistance.get(), 0.5f, 1298332136));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_oak"), VILLAGE_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.villageOakAverageChunkDistance.get(), 0.5f, 2112891039));
        ...
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruined_portal_end"), RUINED_PORTAL_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinedPortalsConfig.ruinedPortalEndAverageChunkDistance.get(), 0.5f, 532404086));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_nether"), RUINS_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsNetherAverageChunkDistance.get(), 0.5f, 1336047555));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_land_warm"), RUINS_LAND_WARM.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsLandWarmAverageChunkDistance.get(), 0.25f, 18646107));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_land_hot"), RUINS_LAND_HOT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsLandHotAverageChunkDistance.get(), 0.25f, 1243670027));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "city_nether"), CITY_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSCitiesConfig.citiesNetherAverageChunkDistance.get(), 0.5f, 2082652405));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_birch"), MANSION_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionBirchAverageChunkDistance.get(), 0.5f, 182367035));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_jungle"), MANSION_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionJungleAverageChunkDistance.get(), 0.5f, 1267916621));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_oak"), MANSION_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionOakAverageChunkDistance.get(), 0.5f, 147853731));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_savanna"), MANSION_SAVANNA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionSavannaAverageChunkDistance.get(), 0.5f, 2024558925));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_taiga"), MANSION_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionTaigaAverageChunkDistance.get(), 0.5f, 418506505));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_desert"), MANSION_DESERT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionDesertAverageChunkDistance.get(), 0.5f, 724317387));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_snowy"), MANSION_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionSnowyAverageChunkDistance.get(), 0.5f, 1115107889));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_oak"), WITCH_HUTS_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsOakAverageChunkDistance.get(), 0.5f, 741641348));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_taiga"), WITCH_HUTS_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsTaigaAverageChunkDistance.get(), 0.5f, 1925189659));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_birch"), WITCH_HUTS_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsBirchAverageChunkDistance.get(), 0.5f, 904634508));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_dark_forest"), WITCH_HUTS_DARK_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsDarkForestAverageChunkDistance.get(), 0.5f, 165100151));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_giant_tree_taiga"), WITCH_HUTS_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsGiantTreeTaigaAverageChunkDistance.get(), 0.5f, 200289401));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "bastion_underground"), BASTION_UNDERGROUND.get(), GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createSpacingAndSalt(RSBastionsConfig.bastionUndergroundAverageChunkDistance.get(), 0.5f, 1359301629));
