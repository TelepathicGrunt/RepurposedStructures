...
public class RSStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_OAK = registerStructure("village_oak", () -> (new GenericJigsawStructure(NoFeatureConfig.CODEC, new ResourceLocation(RepurposedStructures.MODID, "village/oak/town_centers"), 6, 0)));
