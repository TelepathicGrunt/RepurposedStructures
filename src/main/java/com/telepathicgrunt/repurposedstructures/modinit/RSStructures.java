...
public class RSStructures {
    ...
    //Pyramids
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_BADLANDS = addToStructureMaps("pyramid_badlands", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/badlands")).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_SNOWY = addToStructureMaps("pyramid_snowy", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/snowy")).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_ICY = addToStructureMaps("pyramid_icy", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/icy")).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_JUNGLE = addToStructureMaps("pyramid_jungle", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/jungle")).setOffsetAmount(20).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_MUSHROOM = addToStructureMaps("pyramid_mushroom", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/mushroom")).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_OCEAN = addToStructureMaps("pyramid_ocean", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/ocean")).cannotSpawnInWater().useOceanHeightmap().build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_GIANT_TREE_TAIGA = addToStructureMaps("pyramid_giant_tree_taiga", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/giant_tree_taiga")).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_FLOWER_FOREST = addToStructureMaps("pyramid_flower_forest", () -> (new BuriableStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/flower_forest")).build()));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> PYRAMID_END = addToStructureMaps("pyramid_end", () -> (new LandBasedEndStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "pyramids/end")).setStructureSize(11).setCenterOffset(-2).build()));
    ...
    //Villages
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_BADLANDS = addToStructureMaps("village_badlands", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/badlands/town_centers")).setStructureSize(10).setBiomeRange(1).setTerrainHeightRadius(2).setAllowTerrainHeightRange(20).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_BIRCH = addToStructureMaps("village_birch", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/birch/town_centers")).setStructureSize(6).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_DARK_FOREST = addToStructureMaps("village_dark_oak", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/dark_forest/town_centers")).setStructureSize(6).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_JUNGLE = addToStructureMaps("village_jungle", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/jungle/town_centers")).setStructureSize(8).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_SWAMP = addToStructureMaps("village_swamp", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/swamp/town_centers")).setStructureSize(6).setCenterOffset(-1).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_MOUNTAINS = addToStructureMaps("village_mountains", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/mountains/town_centers")).setStructureSize(6).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_GIANT_TAIGA = addToStructureMaps("village_giant_taiga", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/giant_taiga/town_centers")).setStructureSize(6).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_OAK = addToStructureMaps("village_oak", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/oak/town_centers")).setStructureSize(6).setBiomeRange(1).setStructureBlacklistRange(5).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_CRIMSON = addToStructureMaps("village_crimson", () -> (new GenericNetherJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/crimson/town_centers")).setStructureSize(6).searchForHighestLand().setLedgeSpotOffset(-12).setLiquidSpotOffset(-11).setBiomeRange(1).setStructureBlacklistRange(10).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_WARPED = addToStructureMaps("village_warped", () -> (new GenericNetherJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "villages/warped/town_centers")).setStructureSize(6).searchForHighestLand().setLedgeSpotOffset(-12).setLiquidSpotOffset(-11).setBiomeRange(1).setStructureBlacklistRange(10).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST).collect(Collectors.toSet())).build()));

    //Ruined Portals
    public static final RegistryObject<Structure<NoFeatureConfig>> RUINED_PORTAL_END = addToStructureMaps("ruined_portal_end", () -> (new LandBasedEndStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "ruined_portals/end")).setStructureSize(20).setCenterOffset(-6).build()));
    ...
    public static void setupStructures() {
        ...
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mineshaft_nether"), MINESHAFT_NETHER.get(), GenerationStage.Decoration.VEGETAL_DECORATION, new StructureSeparationSettings(1, 0, 1220811654));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mineshaft_crimson"), MINESHAFT_CRIMSON.get(), GenerationStage.Decoration.VEGETAL_DECORATION, new StructureSeparationSettings(1, 0, 1153019610));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mineshaft_warped"), MINESHAFT_WARPED.get(), GenerationStage.Decoration.VEGETAL_DECORATION, new StructureSeparationSettings(1, 0, 1095888662));
        ...
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_basalt"), TEMPLE_NETHER_BASALT.get(), GenerationStage.Decoration.VEGETAL_DECORATION, createSpacingAndSalt(RepurposedStructures.RSTemplesConfig.netherBasaltTempleMaxChunkDistance.get(), 0.5f, 1063117750));
        ...
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_nether"), PYRAMID_NETHER.get(), GenerationStage.Decoration.VEGETAL_DECORATION, createSpacingAndSalt(RepurposedStructures.RSPyramidsConfig.netherPyramidMaxChunkDistance.get(), 0.5f, 2054372964));
        ...
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_oak"), VILLAGE_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RepurposedStructures.RSVillagesConfig.villageOakMaxChunkDistance.get(), 0.5f, 2112891039));
