...
public final class RSStructures {
    ...
    //Mineshafts
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_BIRCH = addToStructureMaps("mineshaft_birch", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/birch/start_pool")).setStructureSize(RSMineshaftsConfig.birchMineshaftSize).setMaxY(RSMineshaftsConfig.birchMineshaftMaxHeight).setMinY(RSMineshaftsConfig.birchMineshaftMinHeight).setProbability(RSMineshaftsConfig.birchMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_DARK_FOREST = addToStructureMaps("mineshaft_dark_forest", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/dark_forest/start_pool")).setStructureSize(RSMineshaftsConfig.darkForestMineshaftSize).setMaxY(RSMineshaftsConfig.darkForestMineshaftMaxHeight).setMinY(RSMineshaftsConfig.darkForestMineshaftMinHeight).setProbability(RSMineshaftsConfig.darkForestMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_DESERT = addToStructureMaps("mineshaft_desert", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/desert/start_pool")).setStructureSize(RSMineshaftsConfig.desertMineshaftSize).setMaxY(RSMineshaftsConfig.desertMineshaftMaxHeight).setMinY(RSMineshaftsConfig.desertMineshaftMinHeight).setProbability(RSMineshaftsConfig.desertMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_ICY = addToStructureMaps("mineshaft_icy", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/icy/start_pool")).setStructureSize(RSMineshaftsConfig.icyMineshaftSize).setMaxY(RSMineshaftsConfig.icyMineshaftMaxHeight).setMinY(RSMineshaftsConfig.icyMineshaftMinHeight).setProbability(RSMineshaftsConfig.icyMineshaftSpawnrate).build()));
    ...
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_OCEAN = addToStructureMaps("mineshaft_ocean", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/ocean/start_pool")).setStructureSize(RSMineshaftsConfig.oceanMineshaftSize).setMaxY(RSMineshaftsConfig.oceanMineshaftMaxHeight).setMinY(RSMineshaftsConfig.oceanMineshaftMinHeight).setProbability(RSMineshaftsConfig.oceanMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_SAVANNA = addToStructureMaps("mineshaft_savanna", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/savanna/start_pool")).setStructureSize(RSMineshaftsConfig.savannaMineshaftSize).setMaxY(RSMineshaftsConfig.savannaMineshaftMaxHeight).setMinY(RSMineshaftsConfig.savannaMineshaftMinHeight).setProbability(RSMineshaftsConfig.savannaMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_STONE = addToStructureMaps("mineshaft_stone", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/stone/start_pool")).setStructureSize(RSMineshaftsConfig.stoneMineshaftSize).setMaxY(RSMineshaftsConfig.stoneMineshaftMaxHeight).setMinY(RSMineshaftsConfig.stoneMineshaftMinHeight).setProbability(RSMineshaftsConfig.stoneMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_SWAMP = addToStructureMaps("mineshaft_swamp", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/swamp/start_pool")).setStructureSize(RSMineshaftsConfig.swampMineshaftSize).setMaxY(RSMineshaftsConfig.swampMineshaftMaxHeight).setMinY(RSMineshaftsConfig.swampMineshaftMinHeight).setProbability(RSMineshaftsConfig.swampMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_TAIGA = addToStructureMaps("mineshaft_taiga", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/taiga/start_pool")).setStructureSize(RSMineshaftsConfig.taigaMineshaftSize).setMaxY(RSMineshaftsConfig.taigaMineshaftMaxHeight).setMinY(RSMineshaftsConfig.taigaMineshaftMinHeight).setProbability(RSMineshaftsConfig.taigaMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_NETHER = addToStructureMaps("mineshaft_nether", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/nether/start_pool")).setStructureSize(RSMineshaftsConfig.netherMineshaftSize).setMaxY(RSMineshaftsConfig.netherMineshaftMaxHeight).setMinY(RSMineshaftsConfig.netherMineshaftMinHeight).setProbability(RSMineshaftsConfig.netherMineshaftSpawnrate).build()));
    ...
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_WARPED = addToStructureMaps("mineshaft_warped", () -> (new MineshaftStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/warped/start_pool")).setStructureSize(RSMineshaftsConfig.warpedMineshaftSize).setMaxY(RSMineshaftsConfig.warpedMineshaftMaxHeight).setMinY(RSMineshaftsConfig.warpedMineshaftMinHeight).setProbability(RSMineshaftsConfig.warpedMineshaftSpawnrate).build()));
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_END = addToStructureMaps("mineshaft_end", () -> (new MineshaftEndStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/end/start_pool")).setStructureSize(RSMineshaftsConfig.endMineshaftSize).setProbability(RSMineshaftsConfig.endMineshaftSpawnrate).build()));

    //Strongholds
    public static final RegistryObject<Structure<NoFeatureConfig>> STRONGHOLD_NETHER = addToStructureMaps("stronghold_nether", () -> (new AdvancedDistanceJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "strongholds/nether/start_pool")).setStructureSize(RSStrongholdsConfig.netherStrongholdSize).setMaxY(RSStrongholdsConfig.netherStrongholdMaxHeight).setMinY(RSStrongholdsConfig.netherStrongholdMinHeight).setDistanceFromWorldOrigin(2817).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> STRONGHOLD_END = addToStructureMaps("stronghold_end", () -> (new StrongholdEndStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "strongholds/end/start_pool")).setStructureSize(RSStrongholdsConfig.strongholdEndSize).setMaxY(RSStrongholdsConfig.strongholdEndMaxHeight).setMinY(RSStrongholdsConfig.strongholdEndMinHeight).setVerticalRange(RSStrongholdsConfig.strongholdEndVerticalRange).setDistanceFromWorldOrigin(8000).doNotClipOutOfBoundsPieces().build()));
    ...
    //Villages
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_BADLANDS = addToStructureMaps("village_badlands", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/badlands/town_centers")).setStructureSize(RSVillagesConfig.badlandsVillageSize).setBiomeRange(1).setTerrainHeightRadius(2).setAllowTerrainHeightRange(20).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_BIRCH = addToStructureMaps("village_birch", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/birch/town_centers")).setStructureSize(RSVillagesConfig.birchVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_DARK_FOREST = addToStructureMaps("village_dark_oak", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/dark_forest/town_centers")).setStructureSize(RSVillagesConfig.darkForestVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_JUNGLE = addToStructureMaps("village_jungle", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/jungle/town_centers")).setStructureSize(RSVillagesConfig.jungleVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_SWAMP = addToStructureMaps("village_swamp", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/swamp/town_centers")).setStructureSize(RSVillagesConfig.swampVillageSize).setCenterOffset(-1).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_MOUNTAINS = addToStructureMaps("village_mountains", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/mountains/town_centers")).setStructureSize(RSVillagesConfig.mountainsVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_GIANT_TAIGA = addToStructureMaps("village_giant_taiga", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/giant_taiga/town_centers")).setStructureSize(RSVillagesConfig.giantTaigaVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_OAK = addToStructureMaps("village_oak", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/oak/town_centers")).setStructureSize(RSVillagesConfig.oakVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_CRIMSON = addToStructureMaps("village_crimson", () -> (new GenericNetherJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/crimson/town_centers")).setStructureSize(RSVillagesConfig.crimsonVillageSize).searchForHighestLand().setLedgeSpotOffset(-12).setLiquidSpotOffset(-11).setBiomeRange(1).setStructureBlacklistRange(10).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_WARPED = addToStructureMaps("village_warped", () -> (new GenericNetherJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/warped/town_centers")).setStructureSize(RSVillagesConfig.warpedVillageSize).searchForHighestLand().setLedgeSpotOffset(-12).setLiquidSpotOffset(-11).setBiomeRange(1).setStructureBlacklistRange(10).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.NETHER_OUTPOST).collect(Collectors.toSet())).build()));
    public static final RegistryObject<Structure<NoFeatureConfig>> VILLAGE_MUSHROOM = addToStructureMaps("village_mushroom", () -> (new GenericJigsawStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "village/mushroom/town_centers")).setStructureSize(RSVillagesConfig.mushroomVillageSize).setBiomeRange(1).setStructureBlacklistRange(6).setAvoidStructuresSet(Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.VILLAGE_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    ...
    public static void setupStructures() {
        ...
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "stronghold_nether"), STRONGHOLD_NETHER.get(), GenerationStage.Decoration.TOP_LAYER_MODIFICATION, createSpacingAndSalt(RSStrongholdsConfig.netherStrongholdMaxChunkDistance.get(), 0.5f, 1731422513));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "stronghold_end"), STRONGHOLD_END.get(), GenerationStage.Decoration.STRONGHOLDS, new StructureSeparationSettings(RSStrongholdsConfig.strongholdEndMaxChunkDistance.get(), (int) (RSStrongholdsConfig.strongholdEndMaxChunkDistance.get() * 0.5f), 1922886435));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "fortress_jungle"), FORTRESS_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSFortressesConfig.jungleFortressMaxChunkDistance.get(), 0.5f, 1464189157));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "igloo_grassy"), IGLOO_GRASSY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSIgloosConfig.grassyIglooMaxChunkDistance.get(), 0.5f, 1460835582));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "igloo_stone"), IGLOO_STONE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSIgloosConfig.stoneIglooMaxChunkDistance.get(), 0.5f, 1327429039));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_wasteland"), TEMPLE_NETHER_WASTELAND.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherWastelandTempleMaxChunkDistance.get(), 0.5f, 1435489909));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_soul"), TEMPLE_NETHER_SOUL.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherSoulTempleMaxChunkDistance.get(), 0.5f, 1799485937));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_basalt"), TEMPLE_NETHER_BASALT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherBasaltTempleMaxChunkDistance.get(), 0.5f, 1063117750));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_crimson"), TEMPLE_NETHER_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherCrimsonTempleMaxChunkDistance.get(), 0.5f, 1898896156));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "temple_nether_warped"), TEMPLE_NETHER_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSTemplesConfig.netherWarpedTempleMaxChunkDistance.get(), 0.5f, 1635542708));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_nether_brick"), OUTPOST_NETHER_BRICK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.netherBrickOutpostMaxChunkDistance.get(), 0.5f, 1305971394));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_warped"), OUTPOST_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.warpedOutpostMaxChunkDistance.get(), 0.5f, 1928816918));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_crimson"), OUTPOST_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.crimsonOutpostMaxChunkDistance.get(), 0.5f, 1951425662));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_birch"), OUTPOST_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostBirchMaxChunkDistance.get(), 0.5f, 1676743168));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_jungle"), OUTPOST_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostJungleMaxChunkDistance.get(), 0.5f, 548433028));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_giant_tree_taiga"), OUTPOST_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostGiantTreeTaigaMaxChunkDistance.get(), 0.5f, 993252541));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_desert"), OUTPOST_DESERT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostDesertMaxChunkDistance.get(), 0.5f, 593099376));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_badlands"), OUTPOST_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostBadlandsMaxChunkDistance.get(), 0.5f, 1702026868));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_snowy"), OUTPOST_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostSnowyMaxChunkDistance.get(), 0.5f, 849388460));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_icy"), OUTPOST_ICY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostIcyMaxChunkDistance.get(), 0.5f, 935294633));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_taiga"), OUTPOST_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostTaigaMaxChunkDistance.get(), 0.5f, 272805097));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_oak"), OUTPOST_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostOakMaxChunkDistance.get(), 0.5f, 698118385));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "outpost_end"), OUTPOST_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSOutpostsConfig.outpostEndMaxChunkDistance.get(), 0.5f, 831830630));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_badlands"), PYRAMID_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.badlandsPyramidMaxChunkDistance.get(), 0.5f, 1718729448));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_nether"), PYRAMID_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.netherPyramidMaxChunkDistance.get(), 0.5f, 2054372964));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_snowy"), PYRAMID_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidSnowyMaxChunkDistance.get(), 0.5f, 1630533493));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_end"), PYRAMID_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidEndMaxChunkDistance.get(), 0.5f, 1145023315));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_icy"), PYRAMID_ICY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidIcyMaxChunkDistance.get(), 0.5f, 884076931));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_jungle"), PYRAMID_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidJungleMaxChunkDistance.get(), 0.5f, 1483015905));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_mushroom"), PYRAMID_MUSHROOM.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidMushroomMaxChunkDistance.get(), 0.5f, 1035759391));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_ocean"), PYRAMID_OCEAN.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidOceanMaxChunkDistance.get(), 0.5f, 777281414));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_giant_tree_taiga"), PYRAMID_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidGiantTreeTaigaMaxChunkDistance.get(), 0.5f, 1977974973));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "pyramid_flower_forest"), PYRAMID_FLOWER_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSPyramidsConfig.pyramidFlowerForestMaxChunkDistance.get(), 0.5f, 1984904323));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_end"), SHIPWRECK_END.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.endShipwreckMaxChunkDistance.get(), 0.5f, 1605500075));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_nether_bricks"), SHIPWRECK_NETHER_BRICKS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.netherBricksShipwreckMaxChunkDistance.get(), 0.5f, 2073308006), new NetherShipwreckConfig(true));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_crimson"), SHIPWRECK_CRIMSON.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.crimsonShipwreckMaxChunkDistance.get(), 0.5f, 1019716871), new NetherShipwreckConfig(false));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "shipwreck_warped"), SHIPWRECK_WARPED.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSShipwrecksConfig.warpedShipwreckMaxChunkDistance.get(), 0.5f, 2072979641), new NetherShipwreckConfig(false));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_badlands"), VILLAGE_BADLANDS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.badlandsVillageMaxChunkDistance.get(), 0.5f, 1319707555));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_birch"), VILLAGE_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.birchVillageMaxChunkDistance.get(), 0.5f, 1102567365));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_dark_oak"), VILLAGE_DARK_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.darkForestVillageMaxChunkDistance.get(), 0.5f, 1921339358));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_jungle"), VILLAGE_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.jungleVillageMaxChunkDistance.get(), 0.5f, 1229975218));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_swamp"), VILLAGE_SWAMP.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.swampVillageMaxChunkDistance.get(), 0.5f, 1559650945));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_mountains"), VILLAGE_MOUNTAINS.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.mountainsVillageMaxChunkDistance.get(), 0.5f, 2010875989));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "village_giant_taiga"), VILLAGE_GIANT_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSVillagesConfig.giantTaigaVillageMaxChunkDistance.get(), 0.5f, 1559528842));
        ...
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_nether"), RUINS_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsNetherMaxChunkDistance.get(), 0.5f, 1336047555));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_land_warm"), RUINS_LAND_WARM.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsLandWarmMaxChunkDistance.get(), 0.25f, 18646107));
        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "ruins_land_hot"), RUINS_LAND_HOT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSRuinsConfig.ruinsLandHotMaxChunkDistance.get(), 0.25f, 1243670027));

        addToTerraformingAndStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "city_nether"), CITY_NETHER.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSCitiesConfig.citiesNetherMaxChunkDistance.get(), 0.5f, 2082652405));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_birch"), MANSION_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionBirchMaxChunkDistance.get(), 0.5f, 182367035));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_jungle"), MANSION_JUNGLE.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionJungleMaxChunkDistance.get(), 0.5f, 1267916621));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_oak"), MANSION_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionOakMaxChunkDistance.get(), 0.5f, 147853731));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_savanna"), MANSION_SAVANNA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionSavannaMaxChunkDistance.get(), 0.5f, 2024558925));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_taiga"), MANSION_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionTaigaMaxChunkDistance.get(), 0.5f, 418506505));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_desert"), MANSION_DESERT.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionDesertMaxChunkDistance.get(), 0.5f, 724317387));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "mansion_snowy"), MANSION_SNOWY.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSMansionsConfig.mansionSnowyMaxChunkDistance.get(), 0.5f, 1115107889));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_oak"), WITCH_HUTS_OAK.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsOakMaxChunkDistance.get(), 0.5f, 741641348));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_taiga"), WITCH_HUTS_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsTaigaMaxChunkDistance.get(), 0.5f, 1925189659));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_birch"), WITCH_HUTS_BIRCH.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsBirchMaxChunkDistance.get(), 0.5f, 904634508));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_dark_forest"), WITCH_HUTS_DARK_FOREST.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsDarkForestMaxChunkDistance.get(), 0.5f, 165100151));
        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "witch_hut_giant_tree_taiga"), WITCH_HUTS_GIANT_TREE_TAIGA.get(), GenerationStage.Decoration.SURFACE_STRUCTURES, createSpacingAndSalt(RSWitchHutsConfig.witchHutsGiantTreeTaigaMaxChunkDistance.get(), 0.5f, 200289401));

        addToStructureMaps(new ResourceLocation(RepurposedStructures.MODID, "bastion_underground"), BASTION_UNDERGROUND.get(), GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createSpacingAndSalt(RSBastionsConfig.bastionUndergroundMaxChunkDistance.get(), 0.5f, 1359301629));
