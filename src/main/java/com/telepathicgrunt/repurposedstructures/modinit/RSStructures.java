...
public class RSStructures {
    ...
    //Mineshafts
    public static final RegistryObject<Structure<NoFeatureConfig>> BIRCH_MINESHAFT = addToStructureMaps("mineshaft_birch", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.BIRCH, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.birchMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.birchMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.birchMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> DESERT_MINESHAFT = addToStructureMaps("mineshaft_desert", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.DESERT, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.desertMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.desertMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.desertMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> END_MINESHAFT = addToStructureMaps("mineshaft_end", () -> (new RSMineshaftEndStructure(RSMineshaftPieces.Type.END, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.endMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.endMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.endMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> NETHER_MINESHAFT = addToStructureMaps("mineshaft_nether", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.NETHER, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.netherMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.netherMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.netherMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> CRIMSON_MINESHAFT = addToStructureMaps("mineshaft_crimson", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.CRIMSON, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.crimsonMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.crimsonMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.crimsonMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> WARPED_MINESHAFT = addToStructureMaps("mineshaft_warped", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.WARPED, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.warpedMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.warpedMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.warpedMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> ICY_MINESHAFT = addToStructureMaps("mineshaft_icy", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.ICY, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.icyMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.icyMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.icyMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> JUNGLE_MINESHAFT = addToStructureMaps("mineshaft_jungle", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.JUNGLE, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.jungleMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.jungleMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.jungleMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> OCEAN_MINESHAFT = addToStructureMaps("mineshaft_ocean", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.OCEAN, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.oceanMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.oceanMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.oceanMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> SAVANNA_MINESHAFT = addToStructureMaps("mineshaft_savanna", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.SAVANNA, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.savannaMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.savannaMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.savannaMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> STONE_MINESHAFT = addToStructureMaps("mineshaft_stone", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.STONE, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.stoneMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.stoneMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.stoneMineshaftMinHeight.get()))));
    public static final RegistryObject<Structure<NoFeatureConfig>> SWAMP_OR_DARK_FOREST_MINESHAFT = addToStructureMaps("mineshaft_swamp_or_dark_forest", () -> (new RSMineshaftStructure(RSMineshaftPieces.Type.SWAMPORDARKFOREST, Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.swampAndDarkForestMineshaftSpawnrate.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.swampAndDarkForestMineshaftMaxHeight.get()), Lazy.of(() -> RepurposedStructures.RSMineshaftsConfig.swampAndDarkForestMineshaftMinHeight.get()))));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> OUTPOST_END = addToStructureMaps("outpost_end", () -> (new GenericJigsawStructure(new ResourceLocation(RepurposedStructures.MODID, "outposts/end/base_plates"), 11, 0, 2, 4, Stream.of(RSStructureTagMap.STRUCTURE_TAGS.END_AVOID_STRUCTURE).collect(Collectors.toSet()), 15, 3, ImmutableList.of(new MobSpawnInfo.Spawners(EntityType.PHANTOM, 10, 1, 1)), ImmutableList.of(), 55)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> JUNGLE_VILLAGE = addToStructureMaps("village_jungle", () -> (new GenericJigsawStructure(new ResourceLocation(RepurposedStructures.MODID, "village/jungle/town_centers"), 8, 0, 1, 5, Stream.of(RSStructureTagMap.STRUCTURE_TAGS.MANSION, RSStructureTagMap.STRUCTURE_TAGS.FORTRESS).collect(Collectors.toSet()))));
