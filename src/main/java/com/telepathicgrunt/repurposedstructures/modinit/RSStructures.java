...
public class RSStructures {
    ...
    public static RegistryObject<Structure<NoFeatureConfig>> MINESHAFT_END = addToStructureMaps("mineshaft_end", () -> (new MineshaftEndStructure.Builder<>(new ResourceLocation(RepurposedStructures.MODID, "mineshafts/end/start_pool")).setStructureSize(RepurposedStructures.RSMineshaftsConfig.endMineshaftSize).setMaxY(RepurposedStructures.RSMineshaftsConfig.endMineshaftMaxHeight).setMinY(RepurposedStructures.RSMineshaftsConfig.endMineshaftMinHeight).setProbability(RepurposedStructures.RSMineshaftsConfig.endMineshaftSpawnrate).doNotClipOutOfBoundsPieces().build()));
