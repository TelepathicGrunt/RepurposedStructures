...
public class StructureModdedLootImporter {
    ...
    public static Map<ResourceKey<LootTable>, ResourceKey<LootTable>> createMap() {
        ...
        tableMap.put(generateKey(RepurposedStructures.MODID, "chests/villages/dappled_house"), generateKey("minecraft", "chests/village/village_plains_house"));
        ...
        tableMap.put(generateKey(RepurposedStructures.MODID, "chests/villages/pale_garden_house"), generateKey("minecraft", "chests/village/village_plains_house"));
