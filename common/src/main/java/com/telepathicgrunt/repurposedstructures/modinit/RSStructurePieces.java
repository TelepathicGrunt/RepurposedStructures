...
public final class RSStructurePieces {
    public static final ResourcefulRegistry<StructurePoolElementType<?>> STRUCTURE_POOL_ELEMENT = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.STRUCTURE_POOL_ELEMENT, RepurposedStructures.MODID);
    public static final ResourcefulRegistry<StructurePieceType> STRUCTURE_PIECE = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.STRUCTURE_PIECE, RepurposedStructures.MODID);
